...
.L0_while_start:
    ...
    bge x3, x4, .L1_while_end                           ; pc=0x0030

    ; if
    lw x4, -8(x17) ; y                                  ; pc=0x0034
    addi x3, x0, 2                                      ; pc=0x0038
    bge x4, x3, .L2_if_else                             ; pc=0x003C
...
.L3_if_end:
    ...
    jal x0, .L0_while_start                             ; pc=0x00A4
.L1_while_end:

    lw x4, -8(x17) ; y                                  ; pc=0x00A8
    add x11, x4, x0                                     ; pc=0x00AC
    jal x0, .L_codegen_1_main_end                       ; pc=0x00B0
