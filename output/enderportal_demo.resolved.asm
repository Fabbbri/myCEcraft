...
; Tabla de etiquetas
;   .L_codegen_0_enderExit = 0x000C
;   main = 0x000C
;   .L_codegen_2_endchange = 0x005C
;   .L_codegen_1_main_end = 0x006C

; Referencias resueltas
;   pc=0x0000 portalv -> .L_codegen_0_enderExit (addr=0x000C, offset=12)
;   pc=0x0030 portalv -> .L_codegen_2_endchange (addr=0x005C, offset=44)
;   pc=0x0064 jal -> .L_codegen_1_main_end (addr=0x006C, offset=8)
...
.text
    ...
    ; @EnterCraftWorld
    portalv x0, x0, 12                                  ; pc=0x0000 ; target=.L_codegen_0_enderExit ; addr=0x000C
...
main:
    ...
    portalv x3, x0, 44                                  ; enderPortal ; pc=0x0030 ; target=.L_codegen_2_endchange ; addr=0x005C
...
.L_codegen_2_endchange:
    ...
    jal x0, 8                                           ; pc=0x0064 ; target=.L_codegen_1_main_end ; addr=0x006C
