...
module tb_top_old;
   ...
   integer csv_fd;
    ...
    top_old dut (.clk(clk), .reset(reset));
    ...
    $dumpfile("sim/waves/tb_top_old.vcd");
    $dumpvars(0, tb_top_old);

    // ======================================
    // Preparar archivo de tipo CSV
    // ======================================

    csv_fd = $fopen("outputs/reports/old_results.csv", "w");
