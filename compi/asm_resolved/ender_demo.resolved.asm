...
;   main = 0x0018
;   .L_codegen_2_endchange = 0x0144
;   .L_codegen_1_main_end = 0x016C

; Referencias resueltas
;   pc=0x0000 portalv -> .L_codegen_0_enderExit (addr=0x0018, offset=24)
;   pc=0x0064 portalv -> .L_codegen_2_endchange (addr=0x0144, offset=224)
;   pc=0x0164 jal -> .L_codegen_1_main_end (addr=0x016C, offset=8)
