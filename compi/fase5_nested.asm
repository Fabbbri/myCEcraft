...
.L_codegen_1_while_start:
    ...
    bge x3, x4, .L_codegen_2_while_end                  ; pc=0x0028

    ; if
    lw x4, -8(x17) ; y                                  ; pc=0x002C
    addi x3, x0, 2                                      ; pc=0x0030
    bge x4, x3, .L_codegen_3_if_else                    ; pc=0x0034
...
.L_codegen_6_if_end:
    ...
    jal x0, .L_codegen_4_if_end                         ; pc=0x0078
.L_codegen_3_if_else:
...
.L_codegen_4_if_end:
    ...
    jal x0, .L_codegen_1_while_start                    ; pc=0x009C
.L_codegen_2_while_end:

    lw x4, -8(x17) ; y                                  ; pc=0x00A0
    add x11, x4, x0                                     ; pc=0x00A4
    jal x0, .L_codegen_0_main_end                       ; pc=0x00A8
