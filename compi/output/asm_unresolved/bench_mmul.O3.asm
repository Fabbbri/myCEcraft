...
.L_ir_9_ir_cmp_end:
    ...
    jal x0, L_while_start_6                             ; pc=0x03C0
L_while_end_7:
    ...
    jal x0, L_while_start_4                             ; pc=0x0400
L_while_end_5:
    ...
    jal x0, L_while_start_2                             ; pc=0x0420
L_while_end_3:
...
L_while_start_8:
    ...
    blt x3, x8, .L_ir_10_ir_cmp_true                    ; pc=0x043C
    jal x0, .L_ir_11_ir_cmp_end                         ; pc=0x0440
.L_ir_10_ir_cmp_true:
    addi x5, x0, 1                                      ; pc=0x0444
.L_ir_11_ir_cmp_end:
    sw x5, -868(x17) ; t23__x4                          ; pc=0x0448
    lw x10, -868(x17) ; t23__x4                         ; pc=0x044C
    beq x10, x0, L_while_end_9                          ; pc=0x0450
    ...
    jal x0, L_while_start_8                             ; pc=0x0508
L_while_end_9:
    add x11, x4, x0                                     ; pc=0x050C
    jal x0, .L_ir_1_main_end                            ; pc=0x0510
.L_ir_1_main_end:
    ; epilogue
