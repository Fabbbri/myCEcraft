...
main:
    ...
    addi x4, x0, 20                                     ; pc=0x0038
    add x12, x4, x0                                     ; pc=0x003C
    addi x5, x0, 30                                     ; pc=0x0040
    add x13, x5, x0                                     ; pc=0x0044
    addi x7, x0, 40                                     ; pc=0x0048
    add x14, x7, x0                                     ; pc=0x004C
    jal x1, calcular                                    ; pc=0x0050
    add x8, x11, x0                                     ; pc=0x0054
    add x6, x8, x0 ; promote t11__x6                    ; pc=0x0058
    add x11, x6, x0                                     ; pc=0x005C
    jal x0, .L_ir_1_main_end                            ; pc=0x0060
.L_ir_1_main_end:
    ; epilogue
...
calcular:
    ...
    sw x8, -68(x17) ; t8__x3                            ; pc=0x00F8
    lw x9, -68(x17) ; t8__x3                            ; pc=0x00FC
    add x7, x9, x4                                      ; pc=0x0100
    sw x7, -72(x17) ; t9__x4                            ; pc=0x0104
    lw x10, -72(x17) ; t9__x4                           ; pc=0x0108
    add x8, x10, x5                                     ; pc=0x010C
    sw x8, -76(x17) ; t10__x5                           ; pc=0x0110
    lw x7, -76(x17) ; t10__x5                           ; pc=0x0114
    add x11, x7, x0                                     ; pc=0x0118
    jal x0, .L_ir_2_calcular_end                        ; pc=0x011C
.L_ir_2_calcular_end:
    ; epilogue
