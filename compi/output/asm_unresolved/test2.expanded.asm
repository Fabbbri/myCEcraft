...
L_for_start_0:
    ...
    blt x3, x6, .L_ir_3_ir_cmp_true                     ; pc=0x010C
    jal x0, .L_ir_4_ir_cmp_end                          ; pc=0x0110
.L_ir_3_ir_cmp_true:
    addi x5, x0, 1                                      ; pc=0x0114
.L_ir_4_ir_cmp_end:
    sw x5, -40(x17) ; t2                                ; pc=0x0118
    lw x7, -40(x17) ; t2                                ; pc=0x011C
    beq x7, x0, L_for_end_1                             ; pc=0x0120
    ...
    blt x4, x6, .L_ir_5_ir_cmp_true                     ; pc=0x014C
    jal x0, .L_ir_6_ir_cmp_end                          ; pc=0x0150
.L_ir_5_ir_cmp_true:
