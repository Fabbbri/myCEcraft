...
main:
    ...
    jal x0, .L_codegen_1_main_end                       ; pc=0x0160
...
.L0_for_start:
    ...
    bge x4, x5, .L1_for_end                             ; pc=0x0258
    ...
    bge x3, x4, .L2_if_else                             ; pc=0x02D4
...
.L1_for_end:
    ...
    jal x0, .L_codegen_2_maximo_lista_end               ; pc=0x03B0
