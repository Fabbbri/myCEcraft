...
main:
    ...
    jal x0, .L_ir_1_main_end                            ; pc=0x009C
.L_ir_1_main_end:
    ; epilogue
...
es_primo:
    ...
    bge x8, x6, .L_ir_3_ir_cmp_true                     ; pc=0x00D0
...
.L_ir_4_ir_cmp_end:
    ...
    beq x3, x0, L_else_0                                ; pc=0x00E4
    addi x9, x0, 0                                      ; pc=0x00E8
    add x11, x9, x0                                     ; pc=0x00EC
    jal x0, .L_ir_2_es_primo_end                        ; pc=0x00F0
    jal x0, L_end_if_1                                  ; pc=0x00F4
L_else_0:
L_end_if_1:
    ...
    blt x7, x4, .L_ir_5_ir_cmp_true                     ; pc=0x0114
...
.L_ir_6_ir_cmp_end:
    ...
    beq x5, x0, L_else_2                                ; pc=0x0128
    addi x8, x0, 1                                      ; pc=0x012C
    add x11, x8, x0                                     ; pc=0x0130
    jal x0, .L_ir_2_es_primo_end                        ; pc=0x0134
    jal x0, L_end_if_3                                  ; pc=0x0138
L_else_2:
L_end_if_3:
    ...
    beq x9, x4, .L_ir_7_ir_cmp_true                     ; pc=0x0178
    jal x0, .L_ir_8_ir_cmp_end                          ; pc=0x017C
.L_ir_7_ir_cmp_true:
...
.L_ir_8_ir_cmp_end:
    ...
    beq x10, x0, L_else_4                               ; pc=0x019C
    addi x5, x0, 0                                      ; pc=0x01A0
    add x11, x5, x0                                     ; pc=0x01A4
    jal x0, .L_ir_2_es_primo_end                        ; pc=0x01A8
    jal x0, L_end_if_5                                  ; pc=0x01AC
L_else_4:
L_end_if_5:
...
L_for_start_6:
    ...
    blt x10, x8, .L_ir_10_ir_cmp_true                   ; pc=0x0238
    jal x0, .L_ir_11_ir_cmp_end                         ; pc=0x023C
.L_ir_10_ir_cmp_true:
    addi x7, x0, 1                                      ; pc=0x0240
.L_ir_11_ir_cmp_end:
    sw x7, -24(x17) ; t8__x7                            ; pc=0x0244
    lw x7, -24(x17) ; t8__x7                            ; pc=0x0248
    beq x7, x0, L_for_end_7                             ; pc=0x024C
...
L_end_if_9:
    ...
    jal x0, L_for_start_6                               ; pc=0x02F0
L_for_end_7:
    lw x9, -8(x17) ; suma                               ; pc=0x02F4
    add x11, x9, x0                                     ; pc=0x02F8
    jal x0, .L_ir_9_sume_end                            ; pc=0x02FC
.L_ir_9_sume_end:
    ; epilogue
