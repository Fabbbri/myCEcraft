...
L_for_start_0:
    ...
    blt x21, x6, .L_ir_7_ir_cmp_true                    ; pc=0x02EC
    jal x0, .L_ir_8_ir_cmp_end                          ; pc=0x02F0
.L_ir_7_ir_cmp_true:
    addi x5, x0, 1                                      ; pc=0x02F4
.L_ir_8_ir_cmp_end:
    sw x5, -60(x17) ; t2                                ; pc=0x02F8
    lw x7, -60(x17) ; t2                                ; pc=0x02FC
    beq x7, x0, L_for_end_1                             ; pc=0x0300
    ...
    jal x0, L_for_start_0                               ; pc=0x0434
L_for_end_1:
...
L_for_start_2:
    ...
    blt x21, x5, .L_ir_10_ir_cmp_true                   ; pc=0x0558
    jal x0, .L_ir_11_ir_cmp_end                         ; pc=0x055C
.L_ir_10_ir_cmp_true:
    addi x7, x0, 1                                      ; pc=0x0560
.L_ir_11_ir_cmp_end:
    sw x7, -60(x17) ; t23                               ; pc=0x0564
    lw x8, -60(x17) ; t23                               ; pc=0x0568
    beq x8, x0, L_for_end_3                             ; pc=0x056C
    ...
    jal x0, L_for_start_2                               ; pc=0x06A0
L_for_end_3:
