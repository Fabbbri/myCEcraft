...
main:
    ...
    jal x0, .L_codegen_1_main_end                       ; pc=0x0078
...
.L0_for_start:
    ...
    bge x4, x6, .L1_for_end                             ; pc=0x00EC
    ...
    blt x3, x4, .L_codegen_3_cmp_true                   ; pc=0x0118
    jal x0, .L_codegen_4_cmp_end                        ; pc=0x011C
...
.L_codegen_4_cmp_end:
    ...
    beq x4, x0, .L2_if_else                             ; pc=0x0134
    lw x4, -16(x17) ; num                               ; pc=0x0138
    sw x4, -12(x17) ; maximo                            ; pc=0x013C
    jal x0, .L3_if_end                                  ; pc=0x0140
.L2_if_else:
.L3_if_end:
    ...
    jal x0, .L0_for_start                               ; pc=0x0154
.L1_for_end:

    lw x6, -12(x17) ; maximo                            ; pc=0x0158
    add x11, x6, x0                                     ; pc=0x015C
    jal x0, .L_codegen_2_maximo_lista_end               ; pc=0x0160
...
sumeMayores:
    ...
    blt x6, x3, .L_codegen_6_cmp_true                   ; pc=0x01C0
    jal x0, .L_codegen_7_cmp_end                        ; pc=0x01C4
...
.L4_while_start:
    ...
    beq x4, x3, .L_codegen_8_cmp_true                   ; pc=0x0210
    jal x0, .L_codegen_9_cmp_end                        ; pc=0x0214
...
.L7_if_end:
    ...
    blt x3, x6, .L_codegen_10_cmp_true                  ; pc=0x0298
    jal x0, .L_codegen_11_cmp_end                       ; pc=0x029C
...
.L9_if_end:
    ...
    blt x4, x3, .L_codegen_12_cmp_true                  ; pc=0x0300
    jal x0, .L_codegen_13_cmp_end                       ; pc=0x0304
.L_codegen_12_cmp_true:
    addi x6, x0, 1                                      ; pc=0x0308
.L_codegen_13_cmp_end:
    sw x6, -16(x17) ; seguir                            ; pc=0x030C
    jal x0, .L4_while_start                             ; pc=0x0310
.L5_while_end:
    ...
    jal x0, .L_codegen_5_sumeMayores_end                ; pc=0x0378
