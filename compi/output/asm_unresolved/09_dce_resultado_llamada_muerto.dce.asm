...
main:
    ...
    jal x0, .L_ir_1_main_end                            ; pc=0x0054
.L_ir_1_main_end:
    ; epilogue
    lw x17, 4(x2)                                       ; pc=0x0058
    addi x2, x2, 20                                     ; pc=0x005C
    freeze                                              ; pc=0x0060
...
registrar:
    ...
    addi x10, x0, 2                                     ; pc=0x0094
    mul x7, x3, x10                                     ; pc=0x0098
    add x5, x7, x0 ; promote t1                         ; pc=0x009C
    add x11, x5, x0                                     ; pc=0x00A0
    jal x0, .L_ir_2_registrar_end                       ; pc=0x00A4
