...
L_for_start_4:
    ...
    blt x20, x6, .L_ir_6_ir_cmp_true                    ; pc=0x00F0
    jal x0, .L_ir_7_ir_cmp_end                          ; pc=0x00F4
.L_ir_6_ir_cmp_true:
    addi x8, x0, 1                                      ; pc=0x00F8
.L_ir_7_ir_cmp_end:
    add x31, x8, x0 ; promote t4                        ; pc=0x00FC
    beq x31, x0, L_for_end_5                            ; pc=0x0100
    ...
    jal x0, L_for_start_4                               ; pc=0x0190
L_for_end_5:
    ...
    jal x0, L_for_start_2                               ; pc=0x01D0
L_for_end_3:
...
L_for_end_1:
    ...
    jal x0, .L_ir_1_main_end                            ; pc=0x027C
.L_ir_1_main_end:
    ; epilogue
