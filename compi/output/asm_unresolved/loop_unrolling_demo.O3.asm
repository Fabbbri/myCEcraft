...
L_while_start_0:
    ...
    blt x7, x8, .L_ir_2_ir_cmp_true                     ; pc=0x007C
    jal x0, .L_ir_3_ir_cmp_end                          ; pc=0x0080
.L_ir_2_ir_cmp_true:
    addi x9, x0, 1                                      ; pc=0x0084
.L_ir_3_ir_cmp_end:
    sw x9, -36(x17) ; t5__x7                            ; pc=0x0088
    lw x7, -36(x17) ; t5__x7                            ; pc=0x008C
    beq x7, x0, L_while_end_1                           ; pc=0x0090
    ...
    jal x0, L_while_start_0                             ; pc=0x0204
L_while_end_1:
    lw x4, -16(x17) ; total                             ; pc=0x0208
    add x11, x4, x0                                     ; pc=0x020C
    jal x0, .L_ir_1_main_end                            ; pc=0x0210
.L_ir_1_main_end:
    ; epilogue
