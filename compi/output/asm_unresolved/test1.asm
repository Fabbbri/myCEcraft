...
main:
    ...
    jal x0, .L_codegen_1_main_end                       ; pc=0x017C
...
es_primo:
    ...
    blt x4, x3, .L0_if_else                             ; pc=0x01FC
...
.L1_if_end:
    ...
    bge x3, x5, .L2_if_else                             ; pc=0x0280
...
.L3_if_end:
    ...
    bne x3, x5, .L4_if_else                             ; pc=0x034C
...
.L5_if_end:
    ...
    jal x0, .L_codegen_2_es_primo_end                   ; pc=0x041C
...
.L6_for_start:
    ...
    bge x4, x3, .L7_for_end                             ; pc=0x04D8
    ...
    beq x4, x0, .L8_if_else                             ; pc=0x0590
...
.L7_for_end:
    ...
    jal x0, .L_codegen_3_sume_end                       ; pc=0x068C
