...
.L_ir_5_ir_cmp_end:
    ...
    beq x7, x0, L_while_end_3                           ; pc=0x02E4
...
L_while_start_4:
    ...
    blt x10, x9, .L_ir_6_ir_cmp_true                    ; pc=0x02FC
...
.L_ir_7_ir_cmp_end:
    ...
    beq x8, x0, L_while_end_5                           ; pc=0x0310
...
L_while_start_8:
    ...
    blt x3, x8, .L_ir_10_ir_cmp_true                    ; pc=0x0464
...
.L_ir_11_ir_cmp_end:
    ...
    beq x9, x0, L_while_end_9                           ; pc=0x0478
