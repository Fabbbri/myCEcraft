...
L_while_start_0:
    ...
    blt x3, x9, .L_ir_2_ir_cmp_true                     ; pc=0x0084
    jal x0, .L_ir_3_ir_cmp_end                          ; pc=0x0088
.L_ir_2_ir_cmp_true:
    addi x10, x0, 1                                     ; pc=0x008C
.L_ir_3_ir_cmp_end:
    add x22, x10, x0 ; promote t1                       ; pc=0x0090
    beq x22, x0, L_while_end_1                          ; pc=0x0094
