...
.L_ir_7_ir_cmp_end:
    ...
    beq x6, x0, L_while_end_5                           ; pc=0x0130
...
L_while_start_6:
    ...
    blt x8, x7, .L_ir_8_ir_cmp_true                     ; pc=0x0158
...
.L_ir_9_ir_cmp_end:
    ...
    beq x7, x0, L_while_end_7                           ; pc=0x016C
...
L_while_start_8:
    ...
    blt x3, x5, .L_ir_10_ir_cmp_true                    ; pc=0x0278
