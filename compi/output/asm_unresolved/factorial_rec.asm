...
fact:
    ...
    blt x4, x3, .L0_if_else                             ; pc=0x0118
    ...
    jal x0, .L_codegen_2_fact_end                       ; pc=0x0140
    sleep ; nop despues de control                      ; pc=0x0144
    jal x0, .L1_if_end                                  ; pc=0x0148
...
.L1_if_end:
    ...
    jal x0, .L_codegen_2_fact_end                       ; pc=0x01D8
