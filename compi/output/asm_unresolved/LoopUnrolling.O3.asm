...
L_for_start_0:
    ...
    blt x4, x7, .L_ir_3_ir_cmp_true                     ; pc=0x00CC
...
L_for_start_2:
    ...
    blt x5, x6, .L_ir_5_ir_cmp_true                     ; pc=0x00F8
...
.L_ir_6_ir_cmp_end:
    ...
    beq x7, x0, L_for_end_3                             ; pc=0x010C
    ...
    jal x0, L_for_start_2                               ; pc=0x0190
L_for_end_3:
...
L_for_end_1:
    ...
    jal x0, .L_ir_2_procesar_bloques_end                ; pc=0x01E8
