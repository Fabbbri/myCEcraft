...
main:
    ...
    beq x8, x10, .L_ir_2_ir_cmp_true                    ; pc=0x01B4
    jal x0, .L_ir_3_ir_cmp_end                          ; pc=0x01B8
.L_ir_2_ir_cmp_true:
    addi x4, x0, 1                                      ; pc=0x01BC
.L_ir_3_ir_cmp_end:
    sw x4, -36(x17) ; t50                               ; pc=0x01C0
    lw x9, -36(x17) ; t50                               ; pc=0x01C4
    beq x9, x0, L_else_4                                ; pc=0x01C8
    ...
    beq x7, x3, .L_ir_4_ir_cmp_true                     ; pc=0x0218
    jal x0, .L_ir_5_ir_cmp_end                          ; pc=0x021C
.L_ir_4_ir_cmp_true:
    addi x5, x0, 1                                      ; pc=0x0220
.L_ir_5_ir_cmp_end:
    sw x5, -48(x17) ; t53                               ; pc=0x0224
    lw x6, -48(x17) ; t53                               ; pc=0x0228
    beq x6, x0, L_else_6                                ; pc=0x022C
    addi x10, x0, 0                                     ; pc=0x0230
    add x11, x10, x0                                    ; pc=0x0234
    jal x0, .L_ir_1_main_end                            ; pc=0x0238
    jal x0, L_end_if_7                                  ; pc=0x023C
L_else_6:
L_end_if_7:
    jal x0, L_end_if_5                                  ; pc=0x0240
L_else_4:
L_end_if_5:
    addi x4, x0, 1                                      ; pc=0x0244
    add x11, x4, x0                                     ; pc=0x0248
    jal x0, .L_ir_1_main_end                            ; pc=0x024C
.L_ir_1_main_end:
    ; epilogue
...
L_for_start_0:
    ...
    blt x7, x10, .L_ir_7_ir_cmp_true                    ; pc=0x02D8
    jal x0, .L_ir_8_ir_cmp_end                          ; pc=0x02DC
.L_ir_7_ir_cmp_true:
    addi x6, x0, 1                                      ; pc=0x02E0
.L_ir_8_ir_cmp_end:
    sw x6, -60(x17) ; t2                                ; pc=0x02E4
    lw x4, -60(x17) ; t2                                ; pc=0x02E8
    beq x4, x0, L_for_end_1                             ; pc=0x02EC
    ...
    jal x0, L_for_start_0                               ; pc=0x04B8
L_for_end_1:
...
L_for_start_2:
    ...
    blt x3, x10, .L_ir_10_ir_cmp_true                   ; pc=0x0588
    jal x0, .L_ir_11_ir_cmp_end                         ; pc=0x058C
.L_ir_10_ir_cmp_true:
    addi x9, x0, 1                                      ; pc=0x0590
.L_ir_11_ir_cmp_end:
    sw x9, -60(x17) ; t23                               ; pc=0x0594
    lw x8, -60(x17) ; t23                               ; pc=0x0598
    beq x8, x0, L_for_end_3                             ; pc=0x059C
    ...
    jal x0, L_for_start_2                               ; pc=0x0768
L_for_end_3:
