...
main:
    ...
    bne x4, x3, .L4_if_else                             ; pc=0x0544
    ...
    bne x4, x3, .L6_if_else                             ; pc=0x062C
    ...
    jal x0, .L_codegen_1_main_end                       ; pc=0x0654
    sleep ; nop despues de control                      ; pc=0x0658
    jal x0, .L7_if_end                                  ; pc=0x065C
    sleep ; nop despues de control                      ; pc=0x0660
.L6_if_else:
.L7_if_end:

    jal x0, .L5_if_end                                  ; pc=0x0664
...
.L5_if_end:
    ...
    jal x0, .L_codegen_1_main_end                       ; pc=0x068C
...
.L0_for_start:
    ...
    bge x5, x3, .L1_for_end                             ; pc=0x080C
...
.L2_for_start:
    ...
    bge x4, x6, .L3_for_end                             ; pc=0x0EE4
