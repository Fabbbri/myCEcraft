...
main:
    ...
    bne x4, x3, .L4_if_else                             ; pc=0x0570
    ...
    bne x4, x3, .L6_if_else                             ; pc=0x065C
...
.L5_if_end:
    ...
    jal x0, .L_codegen_1_main_end                       ; pc=0x06CC
...
.L0_for_start:
    ...
    bge x5, x3, .L1_for_end                             ; pc=0x083C
...
.L2_for_start:
    ...
    bge x4, x6, .L3_for_end                             ; pc=0x0F20
