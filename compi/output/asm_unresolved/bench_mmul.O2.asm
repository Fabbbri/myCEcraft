...
.L_ir_9_ir_cmp_end:
    ...
    jal x0, L_while_start_6                             ; pc=0x01DC
L_while_end_7:
    ...
    jal x0, L_while_start_4                             ; pc=0x0214
L_while_end_5:
    ...
    jal x0, L_while_start_2                             ; pc=0x0234
L_while_end_3:
...
L_while_start_8:
    ...
    blt x3, x10, .L_ir_10_ir_cmp_true                   ; pc=0x0250
    jal x0, .L_ir_11_ir_cmp_end                         ; pc=0x0254
.L_ir_10_ir_cmp_true:
    addi x5, x0, 1                                      ; pc=0x0258
.L_ir_11_ir_cmp_end:
    sw x5, -868(x17) ; t17                              ; pc=0x025C
    lw x8, -868(x17) ; t17                              ; pc=0x0260
    beq x8, x0, L_while_end_9                           ; pc=0x0264
    ...
    jal x0, L_while_start_8                             ; pc=0x02A4
L_while_end_9:
    lw x10, -796(x17) ; suma                            ; pc=0x02A8
    add x11, x10, x0                                    ; pc=0x02AC
    jal x0, .L_ir_1_main_end                            ; pc=0x02B0
.L_ir_1_main_end:
    ; epilogue
