...
L_for_start_2:
    ...
    bge x9, x3, .L_ir_2_ir_cmp_true                     ; pc=0x0048
    jal x0, .L_ir_3_ir_cmp_end                          ; pc=0x004C
.L_ir_2_ir_cmp_true:
    addi x8, x0, 1                                      ; pc=0x0050
.L_ir_3_ir_cmp_end:
    add x5, x8, x0 ; promote t5__x8                     ; pc=0x0054
    beq x5, x0, L_for_end_3                             ; pc=0x0058
    addi x10, x0, 6                                     ; pc=0x005C
    sub x9, x10, x3                                     ; pc=0x0060
    add x6, x9, x0 ; promote t6__x9                     ; pc=0x0064
    add x11, x3, x0                                     ; pc=0x0068
    add x12, x6, x0                                     ; pc=0x006C
    sw x3, -8(x17) ; i                                  ; pc=0x0070
    sw x5, -12(x17) ; spill t5__x8                      ; pc=0x0074
    sw x6, -16(x17) ; spill t6__x9                      ; pc=0x0078
    sw x4, -4(x17) ; total                              ; pc=0x007C
    jal x1, combinar                                    ; pc=0x0080
    add x10, x11, x0                                    ; pc=0x0084
    sw x10, -20(x17) ; t7__x10                          ; pc=0x0088
    lw x4, -4(x17) ; total                              ; pc=0x008C
    lw x10, -20(x17) ; t7__x10                          ; pc=0x0090
    add x7, x4, x10                                     ; pc=0x0094
    add x4, x7, x0 ; promote total                      ; pc=0x0098
    lw x3, -8(x17) ; i                                  ; pc=0x009C
    addi x8, x0, 1                                      ; pc=0x00A0
    add x9, x3, x8                                      ; pc=0x00A4
    add x3, x9, x0 ; promote i                          ; pc=0x00A8
    jal x0, L_for_start_2                               ; pc=0x00AC
L_for_end_3:
    add x11, x4, x0                                     ; pc=0x00B0
    jal x0, .L_ir_1_main_end                            ; pc=0x00B4
.L_ir_1_main_end:
    ; epilogue
...
combinar:
    ...
    blt x6, x4, .L_ir_5_ir_cmp_true                     ; pc=0x00E8
    jal x0, .L_ir_6_ir_cmp_end                          ; pc=0x00EC
.L_ir_5_ir_cmp_true:
    addi x8, x0, 1                                      ; pc=0x00F0
.L_ir_6_ir_cmp_end:
    sw x8, -28(x17) ; t1__x4                            ; pc=0x00F4
    lw x9, -28(x17) ; t1__x4                            ; pc=0x00F8
    beq x9, x0, L_else_0                                ; pc=0x00FC
    ...
    jal x0, .L_ir_4_combinar_end                        ; pc=0x0114
    jal x0, L_end_if_1                                  ; pc=0x0118
L_else_0:
    add x5, x3, x0 ; promote prev_el                    ; pc=0x011C
    add x8, x3, x4                                      ; pc=0x0120
    add x3, x8, x0 ; promote acc                        ; pc=0x0124
    add x7, x3, x5                                      ; pc=0x0128
    sw x7, -40(x17) ; t4__x7                            ; pc=0x012C
    lw x7, -40(x17) ; t4__x7                            ; pc=0x0130
    add x11, x7, x0                                     ; pc=0x0134
    jal x0, .L_ir_4_combinar_end                        ; pc=0x0138
L_end_if_1:
.L_ir_4_combinar_end:
    ; epilogue
