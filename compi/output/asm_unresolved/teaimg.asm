...
DELTA: ; addr=0xAF90
    .word 0x9E3779B9
SUM_INIT: ; addr=0xAF94
    .word 0xC6EF3720
IMAGE_WORDS: ; addr=0xAF98
    .word 0xBDE
...
.L5_for_end:
    ...
    jal x0, .L_codegen_1_main_end                       ; pc=0x0524
...
.L0_for_start:
    ...
    bge x3, x5, .L1_for_end                             ; pc=0x0694
...
.L2_for_start:
    ...
    bge x6, x4, .L3_for_end                             ; pc=0x0D78
