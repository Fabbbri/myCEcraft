...
DELTA: ; addr=0xEA68
    .word 0x9E3779B9
SUM_INIT: ; addr=0xEA6C
    .word 0xC6EF3720
IMAGE_WORDS: ; addr=0xEA70
    .word 0x8DC
...
.L4_for_start:
    ...
    bge x3, x4, .L5_for_end                             ; pc=0x00BC
...
.L6_for_start:
    ...
    bge x5, x6, .L7_for_end                             ; pc=0x0558
...
.L8_for_start:
    ...
    bge x3, x4, .L9_for_end                             ; pc=0x0A08
    ...
    beq x3, x4, .L10_if_else                            ; pc=0x0AF4
...
.L11_if_end:
    ...
    beq x3, x4, .L12_if_else                            ; pc=0x0C18
...
.L9_for_end:
    ...
    bne x5, x3, .L14_if_else                            ; pc=0x0CA4
...
.L15_if_end:
    ...
    jal x0, .L_codegen_1_main_end                       ; pc=0x0D08
...
.L0_for_start:
    ...
    bge x4, x3, .L1_for_end                             ; pc=0x0E78
...
.L2_for_start:
    ...
    bge x5, x6, .L3_for_end                             ; pc=0x155C
