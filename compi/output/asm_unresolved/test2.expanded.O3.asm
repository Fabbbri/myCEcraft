...
main:
    ...
    jal x0, .L_ir_1_main_end                            ; pc=0x008C
.L_ir_1_main_end:
    ; epilogue
...
L_for_start_0:
    ...
    blt x3, x7, .L_ir_3_ir_cmp_true                     ; pc=0x011C
    jal x0, .L_ir_4_ir_cmp_end                          ; pc=0x0120
.L_ir_3_ir_cmp_true:
    addi x8, x0, 1                                      ; pc=0x0124
.L_ir_4_ir_cmp_end:
    sw x8, -52(x17) ; t2__x8                            ; pc=0x0128
    lw x8, -52(x17) ; t2__x8                            ; pc=0x012C
    beq x8, x0, L_for_end_1                             ; pc=0x0130
    ...
    blt x7, x10, .L_ir_5_ir_cmp_true                    ; pc=0x0164
    jal x0, .L_ir_6_ir_cmp_end                          ; pc=0x0168
.L_ir_5_ir_cmp_true:
...
L_end_if_3:
    ...
    jal x0, L_for_start_0                               ; pc=0x01D8
L_for_end_1:
    lw x10, -12(x17) ; maximo                           ; pc=0x01DC
    add x11, x10, x0                                    ; pc=0x01E0
    jal x0, .L_ir_2_maximo_lista_end                    ; pc=0x01E4
