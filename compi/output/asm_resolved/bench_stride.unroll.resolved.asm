...
;   L_while_start_2 = 0x0190
;   .L_ir_4_ir_cmp_true = 0x01A0
;   .L_ir_5_ir_cmp_end = 0x01A4
;   L_while_end_3 = 0x0268
;   .L_ir_1_main_end = 0x0270
...
;   pc=0x0198 blt -> .L_ir_4_ir_cmp_true (addr=0x01A0, offset=8)
;   pc=0x019C jal -> .L_ir_5_ir_cmp_end (addr=0x01A4, offset=8)
;   pc=0x01AC beq -> L_while_end_3 (addr=0x0268, offset=188)
;   pc=0x0264 jal -> L_while_start_2 (addr=0x0190, offset=-212)
;   pc=0x026C jal -> .L_ir_1_main_end (addr=0x0270, offset=4)
...
.L_ir_3_ir_cmp_end:
    sw x9, -1036(x17) ; t6                              ; pc=0x005C
    lw x10, -1036(x17) ; t6                             ; pc=0x0060
...
L_while_start_2:
    ...
    addi x8, x0, 0                                      ; pc=0x0194
    blt x3, x10, 8                                      ; pc=0x0198 ; target=.L_ir_4_ir_cmp_true ; addr=0x01A0
    jal x0, 8                                           ; pc=0x019C ; target=.L_ir_5_ir_cmp_end ; addr=0x01A4
.L_ir_4_ir_cmp_true:
    addi x8, x0, 1                                      ; pc=0x01A0
.L_ir_5_ir_cmp_end:
    sw x8, -1044(x17) ; t8                              ; pc=0x01A4
    lw x5, -1044(x17) ; t8                              ; pc=0x01A8
    beq x5, x0, 188                                     ; pc=0x01AC ; target=L_while_end_3 ; addr=0x0268
    add x6, x3, x3                                      ; pc=0x01B0
    add x6, x6, x6                                      ; pc=0x01B4
    addiSigned x7, x17, -1024                           ; pc=0x01B8
    add x7, x7, x6                                      ; pc=0x01BC
    lw x9, 0(x7)                                        ; pc=0x01C0
    sw x9, -1048(x17) ; t9                              ; pc=0x01C4
    lw x8, -1048(x17) ; t9                              ; pc=0x01C8
    add x10, x4, x8                                     ; pc=0x01CC
    add x4, x10, x0 ; promote suma                      ; pc=0x01D0
    addi x5, x0, 8                                      ; pc=0x01D4
    add x6, x3, x5                                      ; pc=0x01D8
    add x7, x6, x6                                      ; pc=0x01DC
    add x7, x7, x7                                      ; pc=0x01E0
    addiSigned x9, x17, -1024                           ; pc=0x01E4
    add x9, x9, x7                                      ; pc=0x01E8
    lw x10, 0(x9)                                       ; pc=0x01EC
    sw x10, -1056(x17) ; t11                            ; pc=0x01F0
    lw x8, -1056(x17) ; t11                             ; pc=0x01F4
    add x5, x4, x8                                      ; pc=0x01F8
    add x4, x5, x0 ; promote suma                       ; pc=0x01FC
    addi x7, x0, 16                                     ; pc=0x0200
    add x6, x3, x7                                      ; pc=0x0204
    add x9, x6, x6                                      ; pc=0x0208
    add x9, x9, x9                                      ; pc=0x020C
    addiSigned x10, x17, -1024                          ; pc=0x0210
    add x10, x10, x9                                    ; pc=0x0214
    lw x5, 0(x10)                                       ; pc=0x0218
    sw x5, -1064(x17) ; t13                             ; pc=0x021C
    lw x8, -1064(x17) ; t13                             ; pc=0x0220
    add x7, x4, x8                                      ; pc=0x0224
    add x4, x7, x0 ; promote suma                       ; pc=0x0228
    addi x9, x0, 24                                     ; pc=0x022C
    add x6, x3, x9                                      ; pc=0x0230
    add x10, x6, x6                                     ; pc=0x0234
    add x10, x10, x10                                   ; pc=0x0238
    addiSigned x5, x17, -1024                           ; pc=0x023C
    add x5, x5, x10                                     ; pc=0x0240
    lw x7, 0(x5)                                        ; pc=0x0244
    sw x7, -1072(x17) ; t15                             ; pc=0x0248
    lw x8, -1072(x17) ; t15                             ; pc=0x024C
    add x9, x4, x8                                      ; pc=0x0250
    add x4, x9, x0 ; promote suma                       ; pc=0x0254
    addi x10, x0, 32                                    ; pc=0x0258
    add x6, x3, x10                                     ; pc=0x025C
    add x3, x6, x0 ; promote i                          ; pc=0x0260
    jal x0, -212                                        ; pc=0x0264 ; target=L_while_start_2 ; addr=0x0190
L_while_end_3:
    add x11, x4, x0                                     ; pc=0x0268
    jal x0, 4                                           ; pc=0x026C ; target=.L_ir_1_main_end ; addr=0x0270
.L_ir_1_main_end:
    ; epilogue
