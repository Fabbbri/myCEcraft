...
;   main = 0x0018
;   L_for_start_0 = 0x0090
;   .L_ir_2_ir_cmp_true = 0x00A4
;   .L_ir_3_ir_cmp_end = 0x00A8
;   L_for_end_1 = 0x0228
;   .L_ir_1_main_end = 0x02E0

; Referencias resueltas
;   pc=0x0000 portalv -> .L_ir_0_enderExit (addr=0x0018, offset=24)
;   pc=0x009C blt -> .L_ir_2_ir_cmp_true (addr=0x00A4, offset=8)
;   pc=0x00A0 jal -> .L_ir_3_ir_cmp_end (addr=0x00A8, offset=8)
;   pc=0x00B0 beq -> L_for_end_1 (addr=0x0228, offset=376)
;   pc=0x0224 jal -> L_for_start_0 (addr=0x0090, offset=-404)
;   pc=0x02DC jal -> .L_ir_1_main_end (addr=0x02E0, offset=4)
...
L_for_start_0:
    ...
    blt x6, x7, 8                                       ; pc=0x009C ; target=.L_ir_2_ir_cmp_true ; addr=0x00A4
    jal x0, 8                                           ; pc=0x00A0 ; target=.L_ir_3_ir_cmp_end ; addr=0x00A8
.L_ir_2_ir_cmp_true:
    addi x4, x0, 1                                      ; pc=0x00A4
.L_ir_3_ir_cmp_end:
    sw x4, -52(x17) ; t5__x4                            ; pc=0x00A8
    lw x4, -52(x17) ; t5__x4                            ; pc=0x00AC
    beq x4, x0, 376                                     ; pc=0x00B0 ; target=L_for_end_1 ; addr=0x0228
    ...
    jal x0, -404                                        ; pc=0x0224 ; target=L_for_start_0 ; addr=0x0090
L_for_end_1:
    ...
    jal x0, 4                                           ; pc=0x02DC ; target=.L_ir_1_main_end ; addr=0x02E0
.L_ir_1_main_end:
    ; epilogue
