...
;   L_for_end_1 = 0x0124
;   .L_ir_1_main_end = 0x0138

; Referencias resueltas
;   pc=0x0000 portalv -> .L_ir_0_enderExit (addr=0x0018, offset=24)
;   pc=0x0050 blt -> .L_ir_2_ir_cmp_true (addr=0x0058, offset=8)
;   pc=0x0054 jal -> .L_ir_3_ir_cmp_end (addr=0x005C, offset=8)
;   pc=0x0060 beq -> L_for_end_1 (addr=0x0124, offset=196)
;   pc=0x0120 jal -> L_for_start_0 (addr=0x0048, offset=-216)
;   pc=0x0134 jal -> .L_ir_1_main_end (addr=0x0138, offset=4)
...
.L_ir_3_ir_cmp_end:
    ...
    beq x6, x0, 196                                     ; pc=0x0060 ; target=L_for_end_1 ; addr=0x0124
    ...
    jal x0, -216                                        ; pc=0x0120 ; target=L_for_start_0 ; addr=0x0048
L_for_end_1:
    add x10, x4, x5                                     ; pc=0x0124
    sw x10, -72(x17) ; t5                               ; pc=0x0128
    lw x7, -72(x17) ; t5                                ; pc=0x012C
    add x11, x7, x0                                     ; pc=0x0130
    jal x0, 4                                           ; pc=0x0134 ; target=.L_ir_1_main_end ; addr=0x0138
.L_ir_1_main_end:
    ; epilogue
