...
;   .L3_if_end = 0x0350
;   .L1_for_end = 0x0390
;   .L_codegen_2_maximo_lista_end = 0x03BC
...
;   pc=0x0258 bge -> .L1_for_end (addr=0x0390, offset=312)
;   pc=0x02D4 bge -> .L2_if_else (addr=0x0350, offset=124)
;   pc=0x0344 jal -> .L3_if_end (addr=0x0350, offset=12)
;   pc=0x0384 jal -> .L0_for_start (addr=0x0238, offset=-332)
;   pc=0x03B0 jal -> .L_codegen_2_maximo_lista_end (addr=0x03BC, offset=12)
