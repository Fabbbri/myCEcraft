...
.L_ir_6_ir_cmp_end:
    sw x8, -60(x17) ; t6                                ; pc=0x0148
    lw x10, -60(x17) ; t6                               ; pc=0x014C
    beq x10, x0, 20                                     ; pc=0x0150 ; target=L_else_2 ; addr=0x0164
    lw x5, -32(x17) ; resultado                         ; pc=0x0154
    add x6, x4, x5                                      ; pc=0x0158
    add x4, x6, x0 ; promote total                      ; pc=0x015C
    jal x0, 4                                           ; pc=0x0160 ; target=L_end_if_3 ; addr=0x0164
L_else_2:
L_end_if_3:
    addi x8, x0, 1                                      ; pc=0x0164
    add x9, x3, x8                                      ; pc=0x0168
    add x3, x9, x0 ; promote i                          ; pc=0x016C
