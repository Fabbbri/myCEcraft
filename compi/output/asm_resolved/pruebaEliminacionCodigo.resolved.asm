...
;   main = 0x0018
;   L_for_start_0 = 0x00C8
;   .L_ir_2_ir_cmp_true = 0x00D8
;   .L_ir_3_ir_cmp_end = 0x00DC
;   L_for_start_2 = 0x00FC
;   .L_ir_4_ir_cmp_true = 0x010C
;   .L_ir_5_ir_cmp_end = 0x0110
;   L_for_start_4 = 0x0134
;   .L_ir_6_ir_cmp_true = 0x0148
;   .L_ir_7_ir_cmp_end = 0x014C
;   L_for_end_5 = 0x021C
;   L_for_end_3 = 0x0270
;   L_for_end_1 = 0x0280
;   .L_ir_1_main_end = 0x0344

; Referencias resueltas
;   pc=0x0000 portalv -> .L_ir_0_enderExit (addr=0x0018, offset=24)
;   pc=0x00D0 blt -> .L_ir_2_ir_cmp_true (addr=0x00D8, offset=8)
;   pc=0x00D4 jal -> .L_ir_3_ir_cmp_end (addr=0x00DC, offset=8)
;   pc=0x00E4 beq -> L_for_end_1 (addr=0x0280, offset=412)
;   pc=0x0104 blt -> .L_ir_4_ir_cmp_true (addr=0x010C, offset=8)
;   pc=0x0108 jal -> .L_ir_5_ir_cmp_end (addr=0x0110, offset=8)
;   pc=0x0118 beq -> L_for_end_3 (addr=0x0270, offset=344)
;   pc=0x0140 blt -> .L_ir_6_ir_cmp_true (addr=0x0148, offset=8)
;   pc=0x0144 jal -> .L_ir_7_ir_cmp_end (addr=0x014C, offset=8)
;   pc=0x0154 beq -> L_for_end_5 (addr=0x021C, offset=200)
;   pc=0x0218 jal -> L_for_start_4 (addr=0x0134, offset=-228)
;   pc=0x026C jal -> L_for_start_2 (addr=0x00FC, offset=-368)
;   pc=0x027C jal -> L_for_start_0 (addr=0x00C8, offset=-436)
;   pc=0x0340 jal -> .L_ir_1_main_end (addr=0x0344, offset=4)
...
L_for_start_0:
    ...
    blt x3, x6, 8                                       ; pc=0x00D0 ; target=.L_ir_2_ir_cmp_true ; addr=0x00D8
    jal x0, 8                                           ; pc=0x00D4 ; target=.L_ir_3_ir_cmp_end ; addr=0x00DC
.L_ir_2_ir_cmp_true:
    addi x7, x0, 1                                      ; pc=0x00D8
.L_ir_3_ir_cmp_end:
    sw x7, -96(x17) ; t0                                ; pc=0x00DC
    lw x8, -96(x17) ; t0                                ; pc=0x00E0
    beq x8, x0, 412                                     ; pc=0x00E4 ; target=L_for_end_1 ; addr=0x0280
...
L_for_start_2:
    ...
    blt x4, x7, 8                                       ; pc=0x0104 ; target=.L_ir_4_ir_cmp_true ; addr=0x010C
    jal x0, 8                                           ; pc=0x0108 ; target=.L_ir_5_ir_cmp_end ; addr=0x0110
.L_ir_4_ir_cmp_true:
    addi x6, x0, 1                                      ; pc=0x010C
.L_ir_5_ir_cmp_end:
    sw x6, -104(x17) ; t2                               ; pc=0x0110
    lw x8, -104(x17) ; t2                               ; pc=0x0114
    beq x8, x0, 344                                     ; pc=0x0118 ; target=L_for_end_3 ; addr=0x0270
...
L_for_start_4:
    ...
    blt x6, x7, 8                                       ; pc=0x0140 ; target=.L_ir_6_ir_cmp_true ; addr=0x0148
    jal x0, 8                                           ; pc=0x0144 ; target=.L_ir_7_ir_cmp_end ; addr=0x014C
.L_ir_6_ir_cmp_true:
    addi x8, x0, 1                                      ; pc=0x0148
.L_ir_7_ir_cmp_end:
    sw x8, -112(x17) ; t4                               ; pc=0x014C
    lw x10, -112(x17) ; t4                              ; pc=0x0150
    beq x10, x0, 200                                    ; pc=0x0154 ; target=L_for_end_5 ; addr=0x021C
    ...
    jal x0, -228                                        ; pc=0x0218 ; target=L_for_start_4 ; addr=0x0134
L_for_end_5:
    ...
    jal x0, -368                                        ; pc=0x026C ; target=L_for_start_2 ; addr=0x00FC
L_for_end_3:
    addi x10, x0, 1                                     ; pc=0x0270
    add x9, x3, x10                                     ; pc=0x0274
    add x3, x9, x0 ; promote i                          ; pc=0x0278
    jal x0, -436                                        ; pc=0x027C ; target=L_for_start_0 ; addr=0x00C8
L_for_end_1:
    ...
    jal x0, 4                                           ; pc=0x0340 ; target=.L_ir_1_main_end ; addr=0x0344
.L_ir_1_main_end:
    ; epilogue
