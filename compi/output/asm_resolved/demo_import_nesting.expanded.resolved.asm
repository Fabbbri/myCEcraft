...
;   suma1 = 0x00CC
;   .L_codegen_2_suma1_end = 0x0140
;   suma2 = 0x0178
;   .L_codegen_3_suma2_end = 0x0214

; Referencias resueltas
;   pc=0x0000 portalv -> .L_codegen_0_enderExit (addr=0x001C, offset=28)
;   pc=0x0064 jal -> suma2 (addr=0x0178, offset=276)
;   pc=0x008C jal -> .L_codegen_1_main_end (addr=0x0094, offset=8)
;   pc=0x0138 jal -> .L_codegen_2_suma1_end (addr=0x0140, offset=8)
;   pc=0x01C4 jal -> suma1 (addr=0x00CC, offset=-248)
;   pc=0x020C jal -> .L_codegen_3_suma2_end (addr=0x0214, offset=8)
...
main:
    ...
    jal x1, 276                                         ; pc=0x0064 ; target=suma2 ; addr=0x0178
...
suma1:
    ...
    jal x0, 8                                           ; pc=0x0138 ; target=.L_codegen_2_suma1_end ; addr=0x0140
...
suma2:
    ...
    jal x1, -248                                        ; pc=0x01C4 ; target=suma1 ; addr=0x00CC
    ...
    jal x0, 8                                           ; pc=0x020C ; target=.L_codegen_3_suma2_end ; addr=0x0214
...
.L_codegen_3_suma2_end:
    ...
    ; final de programa
    addiHIGH x1, x0, 0xDEAD                             ; pc=0x024C
