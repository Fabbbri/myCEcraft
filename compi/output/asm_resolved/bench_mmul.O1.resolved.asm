...
.L_ir_5_ir_cmp_end:
    ...
    beq x5, x0, 360                                     ; pc=0x02E4 ; target=L_while_end_3 ; addr=0x044C
...
L_while_start_4:
    ...
    blt x6, x10, 8                                      ; pc=0x02FC ; target=.L_ir_6_ir_cmp_true ; addr=0x0304
...
.L_ir_7_ir_cmp_end:
    ...
    beq x6, x0, 284                                     ; pc=0x0310 ; target=L_while_end_5 ; addr=0x042C
