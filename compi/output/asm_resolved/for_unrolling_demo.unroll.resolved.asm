...
;   pc=0x006C beq -> L_for_end_1 (addr=0x0108, offset=156)
;   pc=0x0104 jal -> L_for_start_0 (addr=0x0050, offset=-180)
...
main:
    ...
    add x3, x7, x0 ; promote suma                       ; pc=0x0034
    addi x8, x0, 1                                      ; pc=0x0038
    add x5, x8, x0 ; promote producto                   ; pc=0x003C
    addi x9, x0, 0                                      ; pc=0x0040
    add x4, x9, x0 ; promote total                      ; pc=0x0044
    addi x10, x0, 0                                     ; pc=0x0048
    add x6, x10, x0 ; promote i                         ; pc=0x004C
L_for_start_0:
...
.L_ir_3_ir_cmp_end:
    sw x8, -20(x17) ; t5                                ; pc=0x0064
    lw x9, -20(x17) ; t5                                ; pc=0x0068
    beq x9, x0, 156                                     ; pc=0x006C ; target=L_for_end_1 ; addr=0x0108
    add x10, x3, x6                                     ; pc=0x0070
    add x3, x10, x0 ; promote suma                      ; pc=0x0074
    addi x8, x0, 2                                      ; pc=0x0078
    mul x7, x5, x8                                      ; pc=0x007C
    add x5, x7, x0 ; promote producto                   ; pc=0x0080
    ...
    add x5, x10, x0 ; promote producto                  ; pc=0x00A4
    ...
    add x5, x7, x0 ; promote producto                   ; pc=0x00C8
    ...
    add x5, x10, x0 ; promote producto                  ; pc=0x00EC
    ...
    jal x0, -180                                        ; pc=0x0104 ; target=L_for_start_0 ; addr=0x0050
L_for_end_1:
