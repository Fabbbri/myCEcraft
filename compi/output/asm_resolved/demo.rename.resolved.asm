...
;   pc=0x0068 jal -> .L_ir_1_main_end (addr=0x006C, offset=4)
...
L_while_start_0:
    ...
    blt x3, x7, 8                                       ; pc=0x0040 ; target=.L_ir_2_ir_cmp_true ; addr=0x0048
    jal x0, 8                                           ; pc=0x0044 ; target=.L_ir_3_ir_cmp_end ; addr=0x004C
.L_ir_2_ir_cmp_true:
    addi x8, x0, 1                                      ; pc=0x0048
.L_ir_3_ir_cmp_end:
    add x4, x8, x0 ; promote t0__x3                     ; pc=0x004C
...
L_while_end_1:
    ...
    jal x0, 4                                           ; pc=0x0068 ; target=.L_ir_1_main_end ; addr=0x006C
.L_ir_1_main_end:
    ; epilogue
