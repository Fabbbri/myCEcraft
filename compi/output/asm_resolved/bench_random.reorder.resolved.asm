...
;   .L_ir_6_ir_cmp_true = 0x0110
;   .L_ir_7_ir_cmp_end = 0x0114
;   L_else_4 = 0x0130
;   L_end_if_5 = 0x0130
;   L_while_end_3 = 0x0140
...
;   pc=0x00C0 beq -> L_while_end_3 (addr=0x0140, offset=128)
;   pc=0x0108 bge -> .L_ir_6_ir_cmp_true (addr=0x0110, offset=8)
;   pc=0x010C jal -> .L_ir_7_ir_cmp_end (addr=0x0114, offset=8)
;   pc=0x011C beq -> L_else_4 (addr=0x0130, offset=20)
;   pc=0x012C jal -> L_end_if_5 (addr=0x0130, offset=4)
;   pc=0x013C jal -> L_while_start_2 (addr=0x00A4, offset=-152)
...
.L_ir_5_ir_cmp_end:
    ...
    beq x10, x0, 128                                    ; pc=0x00C0 ; target=L_while_end_3 ; addr=0x0140
    ...
    addi x7, x0, 341                                    ; pc=0x00DC
    add x6, x4, x7                                      ; pc=0x00E0
    sw x6, -1952(x17) ; t5                              ; pc=0x00E4
    lw x10, -1932(x17) ; suma                           ; pc=0x00E8
    lw x8, -1948(x17) ; t3                              ; pc=0x00EC
    add x9, x10, x8                                     ; pc=0x00F0
    sw x9, -1932(x17) ; suma                            ; pc=0x00F4
    lw x5, -1952(x17) ; t5                              ; pc=0x00F8
    add x4, x5, x0 ; promote idx                        ; pc=0x00FC
    addi x6, x0, 480                                    ; pc=0x0100
    addi x7, x0, 0                                      ; pc=0x0104
    bge x4, x6, 8                                       ; pc=0x0108 ; target=.L_ir_6_ir_cmp_true ; addr=0x0110
    jal x0, 8                                           ; pc=0x010C ; target=.L_ir_7_ir_cmp_end ; addr=0x0114
.L_ir_6_ir_cmp_true:
    addi x7, x0, 1                                      ; pc=0x0110
.L_ir_7_ir_cmp_end:
    sw x7, -1960(x17) ; t6                              ; pc=0x0114
    lw x9, -1960(x17) ; t6                              ; pc=0x0118
    beq x9, x0, 20                                      ; pc=0x011C ; target=L_else_4 ; addr=0x0130
    addi x8, x0, 480                                    ; pc=0x0120
    sub x10, x4, x8                                     ; pc=0x0124
    add x4, x10, x0 ; promote idx                       ; pc=0x0128
    jal x0, 4                                           ; pc=0x012C ; target=L_end_if_5 ; addr=0x0130
L_else_4:
L_end_if_5:
    addi x5, x0, 1                                      ; pc=0x0130
    add x7, x3, x5                                      ; pc=0x0134
    add x3, x7, x0 ; promote i                          ; pc=0x0138
    jal x0, -152                                        ; pc=0x013C ; target=L_while_start_2 ; addr=0x00A4
L_while_end_3:
    lw x6, -1932(x17) ; suma                            ; pc=0x0140
    add x11, x6, x0                                     ; pc=0x0144
    jal x0, 4                                           ; pc=0x0148 ; target=.L_ir_1_main_end ; addr=0x014C
.L_ir_1_main_end:
    ; epilogue
    lw x17, 4(x2)                                       ; pc=0x014C
    addi x2, x2, 1976                                   ; pc=0x0150
    freeze                                              ; pc=0x0154