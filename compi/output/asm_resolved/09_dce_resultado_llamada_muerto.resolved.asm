...
;   registrar = 0x0088
;   .L_ir_2_registrar_end = 0x00CC

; Referencias resueltas
;   pc=0x0000 portalv -> .L_ir_0_enderExit (addr=0x0018, offset=24)
;   pc=0x004C jal -> registrar (addr=0x0088, offset=60)
;   pc=0x0078 jal -> .L_ir_1_main_end (addr=0x007C, offset=4)
;   pc=0x00C8 jal -> .L_ir_2_registrar_end (addr=0x00CC, offset=4)
...
main:
    ...
    jal x1, 60                                          ; pc=0x004C ; target=registrar ; addr=0x0088
...
registrar:
    ...
    jal x0, 4                                           ; pc=0x00C8 ; target=.L_ir_2_registrar_end ; addr=0x00CC
