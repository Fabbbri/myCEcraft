...
;   .L_ir_5_ir_cmp_true = 0x0114
;   .L_ir_6_ir_cmp_end = 0x0118
;   L_else_2 = 0x0164
;   L_end_if_3 = 0x0164
...
;   pc=0x010C blt -> .L_ir_5_ir_cmp_true (addr=0x0114, offset=8)
;   pc=0x0110 jal -> .L_ir_6_ir_cmp_end (addr=0x0118, offset=8)
;   pc=0x0120 beq -> L_else_2 (addr=0x0164, offset=68)
...
.L_ir_4_ir_cmp_end:
    ...
    addi x5, x0, 50                                     ; pc=0x0104
    addi x6, x0, 0                                      ; pc=0x0108
    blt x5, x10, 8                                      ; pc=0x010C ; target=.L_ir_5_ir_cmp_true ; addr=0x0114
    jal x0, 8                                           ; pc=0x0110 ; target=.L_ir_6_ir_cmp_end ; addr=0x0118
.L_ir_5_ir_cmp_true:
    addi x6, x0, 1                                      ; pc=0x0114
.L_ir_6_ir_cmp_end:
    sw x6, -48(x17) ; t6                                ; pc=0x0118
    lw x8, -48(x17) ; t6                                ; pc=0x011C
    beq x8, x0, 68                                      ; pc=0x0120 ; target=L_else_2 ; addr=0x0164
    lw x9, -16(x17) ; lectura                           ; pc=0x0124
    addi x7, x0, 2                                      ; pc=0x0128
    mul x6, x9, x7                                      ; pc=0x012C
    sw x6, -24(x17) ; promedio                          ; pc=0x0130
    lw x5, -24(x17) ; promedio                          ; pc=0x0134
    addi x10, x0, 10                                    ; pc=0x0138
    add x8, x5, x10                                     ; pc=0x013C
    sw x8, -28(x17) ; ajuste                            ; pc=0x0140
    lw x6, -28(x17) ; ajuste                            ; pc=0x0144
    addi x7, x0, 3                                      ; pc=0x0148
    mul x9, x6, x7                                      ; pc=0x014C
    sw x9, -32(x17) ; resultado                         ; pc=0x0150
    lw x8, -32(x17) ; resultado                         ; pc=0x0154
    add x10, x4, x8                                     ; pc=0x0158
    add x4, x10, x0 ; promote total                     ; pc=0x015C
    jal x0, 4                                           ; pc=0x0160 ; target=L_end_if_3 ; addr=0x0164
L_else_2:
L_end_if_3:
    addi x5, x0, 1                                      ; pc=0x0164
    add x9, x3, x5                                      ; pc=0x0168
