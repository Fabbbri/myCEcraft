...
;   main = 0x0018
;   .L_ir_2_ir_cmp_true = 0x00BC
;   .L_ir_3_ir_cmp_end = 0x00C0
;   L_else_2 = 0x00E8
;   L_end_if_3 = 0x00FC
;   .L_ir_1_main_end = 0x00FC
;   ajustar = 0x0108
;   .L_ir_5_ir_cmp_true = 0x012C
;   .L_ir_6_ir_cmp_end = 0x0130
;   L_else_0 = 0x0150
;   L_end_if_1 = 0x0164
;   .L_ir_4_ajustar_end = 0x0164

; Referencias resueltas
;   pc=0x0000 portalv -> .L_ir_0_enderExit (addr=0x0018, offset=24)
;   pc=0x0098 jal -> ajustar (addr=0x0108, offset=112)
;   pc=0x00B4 blt -> .L_ir_2_ir_cmp_true (addr=0x00BC, offset=8)
;   pc=0x00B8 jal -> .L_ir_3_ir_cmp_end (addr=0x00C0, offset=8)
;   pc=0x00C8 beq -> L_else_2 (addr=0x00E8, offset=32)
;   pc=0x00E0 jal -> .L_ir_1_main_end (addr=0x00FC, offset=28)
;   pc=0x00E4 jal -> L_end_if_3 (addr=0x00FC, offset=24)
;   pc=0x00F8 jal -> .L_ir_1_main_end (addr=0x00FC, offset=4)
;   pc=0x0124 blt -> .L_ir_5_ir_cmp_true (addr=0x012C, offset=8)
;   pc=0x0128 jal -> .L_ir_6_ir_cmp_end (addr=0x0130, offset=8)
;   pc=0x0134 beq -> L_else_0 (addr=0x0150, offset=28)
;   pc=0x0148 jal -> .L_ir_4_ajustar_end (addr=0x0164, offset=28)
;   pc=0x014C jal -> L_end_if_1 (addr=0x0164, offset=24)
;   pc=0x0160 jal -> .L_ir_4_ajustar_end (addr=0x0164, offset=4)
...
main:
    ...
    lw x5, -32(x17) ; t3                                ; pc=0x005C
    sw x5, -12(x17) ; a                                 ; pc=0x0060
    addi x6, x0, 6                                      ; pc=0x0064
    sw x6, -16(x17) ; b                                 ; pc=0x0068
    ...
    jal x1, 112                                         ; pc=0x0098 ; target=ajustar ; addr=0x0108
    ...
    blt x6, x3, 8                                       ; pc=0x00B4 ; target=.L_ir_2_ir_cmp_true ; addr=0x00BC
    jal x0, 8                                           ; pc=0x00B8 ; target=.L_ir_3_ir_cmp_end ; addr=0x00C0
.L_ir_2_ir_cmp_true:
    addi x5, x0, 1                                      ; pc=0x00BC
.L_ir_3_ir_cmp_end:
    sw x5, -48(x17) ; t7                                ; pc=0x00C0
    lw x10, -48(x17) ; t7                               ; pc=0x00C4
    beq x10, x0, 32                                     ; pc=0x00C8 ; target=L_else_2 ; addr=0x00E8
    ...
    jal x0, 28                                          ; pc=0x00E0 ; target=.L_ir_1_main_end ; addr=0x00FC
    jal x0, 24                                          ; pc=0x00E4 ; target=L_end_if_3 ; addr=0x00FC
L_else_2:
    sub x8, x4, x3                                      ; pc=0x00E8
    sw x8, -56(x17) ; t9                                ; pc=0x00EC
    lw x5, -56(x17) ; t9                                ; pc=0x00F0
    add x11, x5, x0                                     ; pc=0x00F4
    jal x0, 4                                           ; pc=0x00F8 ; target=.L_ir_1_main_end ; addr=0x00FC
L_end_if_3:
.L_ir_1_main_end:
    ; epilogue
...
ajustar:
    ...
    blt x7, x3, 8                                       ; pc=0x0124 ; target=.L_ir_5_ir_cmp_true ; addr=0x012C
    jal x0, 8                                           ; pc=0x0128 ; target=.L_ir_6_ir_cmp_end ; addr=0x0130
.L_ir_5_ir_cmp_true:
    addi x8, x0, 1                                      ; pc=0x012C
.L_ir_6_ir_cmp_end:
    add x4, x8, x0 ; promote t0                         ; pc=0x0130
    beq x4, x0, 28                                      ; pc=0x0134 ; target=L_else_0 ; addr=0x0150
    addi x9, x0, 3                                      ; pc=0x0138
    sub x10, x3, x9                                     ; pc=0x013C
    add x5, x10, x0 ; promote t1                        ; pc=0x0140
    add x11, x5, x0                                     ; pc=0x0144
    jal x0, 28                                          ; pc=0x0148 ; target=.L_ir_4_ajustar_end ; addr=0x0164
    jal x0, 24                                          ; pc=0x014C ; target=L_end_if_1 ; addr=0x0164
L_else_0:
    addi x8, x0, 3                                      ; pc=0x0150
    add x7, x3, x8                                      ; pc=0x0154
    add x6, x7, x0 ; promote t2                         ; pc=0x0158
    add x11, x6, x0                                     ; pc=0x015C
    jal x0, 4                                           ; pc=0x0160 ; target=.L_ir_4_ajustar_end ; addr=0x0164
L_end_if_1:
.L_ir_4_ajustar_end:
    ; epilogue
