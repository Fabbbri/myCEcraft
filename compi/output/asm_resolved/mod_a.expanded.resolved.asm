...
;   suma1 = 0x001C
;   .L_codegen_1_suma1_end = 0x0090
;   suma2 = 0x00C8
;   .L_codegen_2_suma2_end = 0x0164

; Referencias resueltas
;   pc=0x0000 portalv -> .L_codegen_0_enderExit (addr=0x001C, offset=28)
;   pc=0x0088 jal -> .L_codegen_1_suma1_end (addr=0x0090, offset=8)
;   pc=0x0114 jal -> suma1 (addr=0x001C, offset=-248)
;   pc=0x015C jal -> .L_codegen_2_suma2_end (addr=0x0164, offset=8)
...
suma1:
    ...
    jal x0, 8                                           ; pc=0x0088 ; target=.L_codegen_1_suma1_end ; addr=0x0090
...
suma2:
    ...
    jal x1, -248                                        ; pc=0x0114 ; target=suma1 ; addr=0x001C
    ...
    jal x0, 8                                           ; pc=0x015C ; target=.L_codegen_2_suma2_end ; addr=0x0164
