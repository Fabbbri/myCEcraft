...
;   main = 0x001C
;   .L0_while_start = 0x0108
;   .L2_if_else = 0x01D8
;   .L3_if_end = 0x020C
;   .L1_while_end = 0x0214
;   .L_codegen_1_main_end = 0x023C

; Referencias resueltas
;   pc=0x0000 portalv -> .L_codegen_0_enderExit (addr=0x001C, offset=28)
;   pc=0x0128 bge -> .L1_while_end (addr=0x0214, offset=236)
;   pc=0x01A0 bne -> .L2_if_else (addr=0x01D8, offset=56)
;   pc=0x01D0 jal -> .L3_if_end (addr=0x020C, offset=60)
;   pc=0x020C jal -> .L0_while_start (addr=0x0108, offset=-260)
;   pc=0x0234 jal -> .L_codegen_1_main_end (addr=0x023C, offset=8)
...
.L_codegen_1_main_end:
    ...
    ; final de programa
    addiHIGH x1, x0, 0xDEAD                             ; pc=0x0274
