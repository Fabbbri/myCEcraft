...
;   main = 0x0018
;   .L0_while_start = 0x0104
;   .L2_if_else = 0x01D4
;   .L3_if_end = 0x0208
;   .L1_while_end = 0x0210
;   .L_codegen_1_main_end = 0x0238

; Referencias resueltas
;   pc=0x0000 portalv -> .L_codegen_0_enderExit (addr=0x0018, offset=24)
;   pc=0x0124 bge -> .L1_while_end (addr=0x0210, offset=236)
;   pc=0x019C bne -> .L2_if_else (addr=0x01D4, offset=56)
;   pc=0x01CC jal -> .L3_if_end (addr=0x0208, offset=60)
;   pc=0x0208 jal -> .L0_while_start (addr=0x0104, offset=-260)
;   pc=0x0230 jal -> .L_codegen_1_main_end (addr=0x0238, offset=8)
...
.L0_while_start:
    ...
    bge x4, x3, 236                                     ; pc=0x0124 ; target=.L1_while_end ; addr=0x0210
    ...
    bne x4, x5, 56                                      ; pc=0x019C ; target=.L2_if_else ; addr=0x01D4
    ...
    jal x0, 60                                          ; pc=0x01CC ; target=.L3_if_end ; addr=0x0208
...
.L3_if_end:
    ...
    jal x0, -260                                        ; pc=0x0208 ; target=.L0_while_start ; addr=0x0104
...
.L1_while_end:
    ...
    jal x0, 8                                           ; pc=0x0230 ; target=.L_codegen_1_main_end ; addr=0x0238
