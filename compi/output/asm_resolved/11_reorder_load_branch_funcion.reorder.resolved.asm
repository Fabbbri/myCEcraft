...
;   main = 0x0018
;   .L_ir_2_ir_cmp_true = 0x00C8
;   .L_ir_3_ir_cmp_end = 0x00CC
;   L_else_2 = 0x00F4
;   L_end_if_3 = 0x00F4
;   .L_ir_1_main_end = 0x0100
;   seleccionar = 0x010C
;   .L_ir_5_ir_cmp_true = 0x0130
;   .L_ir_6_ir_cmp_end = 0x0134
;   L_else_0 = 0x0148
;   L_end_if_1 = 0x0148
;   .L_ir_4_seleccionar_end = 0x0150

; Referencias resueltas
;   pc=0x0000 portalv -> .L_ir_0_enderExit (addr=0x0018, offset=24)
;   pc=0x00A4 jal -> seleccionar (addr=0x010C, offset=104)
;   pc=0x00C0 beq -> .L_ir_2_ir_cmp_true (addr=0x00C8, offset=8)
;   pc=0x00C4 jal -> .L_ir_3_ir_cmp_end (addr=0x00CC, offset=8)
;   pc=0x00D4 beq -> L_else_2 (addr=0x00F4, offset=32)
;   pc=0x00EC jal -> .L_ir_1_main_end (addr=0x0100, offset=20)
;   pc=0x00F0 jal -> L_end_if_3 (addr=0x00F4, offset=4)
;   pc=0x00FC jal -> .L_ir_1_main_end (addr=0x0100, offset=4)
;   pc=0x0128 blt -> .L_ir_5_ir_cmp_true (addr=0x0130, offset=8)
;   pc=0x012C jal -> .L_ir_6_ir_cmp_end (addr=0x0134, offset=8)
;   pc=0x0138 beq -> L_else_0 (addr=0x0148, offset=16)
;   pc=0x0140 jal -> .L_ir_4_seleccionar_end (addr=0x0150, offset=16)
;   pc=0x0144 jal -> L_end_if_1 (addr=0x0148, offset=4)
;   pc=0x014C jal -> .L_ir_4_seleccionar_end (addr=0x0150, offset=4)
...
main:
    ...
    jal x1, 104                                         ; pc=0x00A4 ; target=seleccionar ; addr=0x010C
    ...
    beq x4, x7, 8                                       ; pc=0x00C0 ; target=.L_ir_2_ir_cmp_true ; addr=0x00C8
    jal x0, 8                                           ; pc=0x00C4 ; target=.L_ir_3_ir_cmp_end ; addr=0x00CC
.L_ir_2_ir_cmp_true:
    addi x9, x0, 1                                      ; pc=0x00C8
.L_ir_3_ir_cmp_end:
    sw x9, -48(x17) ; t5                                ; pc=0x00CC
    lw x5, -48(x17) ; t5                                ; pc=0x00D0
    beq x5, x0, 32                                      ; pc=0x00D4 ; target=L_else_2 ; addr=0x00F4
    ...
    jal x0, 20                                          ; pc=0x00EC ; target=.L_ir_1_main_end ; addr=0x0100
    jal x0, 4                                           ; pc=0x00F0 ; target=L_end_if_3 ; addr=0x00F4
L_else_2:
L_end_if_3:
...
seleccionar:
    ...
    blt x3, x4, 8                                       ; pc=0x0128 ; target=.L_ir_5_ir_cmp_true ; addr=0x0130
    jal x0, 8                                           ; pc=0x012C ; target=.L_ir_6_ir_cmp_end ; addr=0x0134
.L_ir_5_ir_cmp_true:
    addi x6, x0, 1                                      ; pc=0x0130
.L_ir_6_ir_cmp_end:
    add x5, x6, x0 ; promote t0                         ; pc=0x0134
    beq x5, x0, 16                                      ; pc=0x0138 ; target=L_else_0 ; addr=0x0148
    add x11, x4, x0                                     ; pc=0x013C
    jal x0, 16                                          ; pc=0x0140 ; target=.L_ir_4_seleccionar_end ; addr=0x0150
    jal x0, 4                                           ; pc=0x0144 ; target=L_end_if_1 ; addr=0x0148
L_else_0:
L_end_if_1:
    add x11, x3, x0                                     ; pc=0x0148
    jal x0, 4                                           ; pc=0x014C ; target=.L_ir_4_seleccionar_end ; addr=0x0150
