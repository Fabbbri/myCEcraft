...
.L_ir_5_ir_cmp_end:
    ...
    lw x6, -1048(x17) ; t9__x6                          ; pc=0x01C8
    add x9, x4, x6                                      ; pc=0x01CC
    add x4, x9, x0 ; promote suma                       ; pc=0x01D0
    addi x10, x0, 8                                     ; pc=0x01D4
    add x5, x3, x10                                     ; pc=0x01D8
    add x8, x5, x5                                      ; pc=0x01DC
    add x8, x8, x8                                      ; pc=0x01E0
    addiSigned x7, x17, -1024                           ; pc=0x01E4
    add x7, x7, x8                                      ; pc=0x01E8
    lw x9, 0(x7)                                        ; pc=0x01EC
    sw x9, -1056(x17) ; t11__x8                         ; pc=0x01F0
    lw x8, -1056(x17) ; t11__x8                         ; pc=0x01F4
    add x6, x4, x8                                      ; pc=0x01F8
    add x4, x6, x0 ; promote suma                       ; pc=0x01FC
    addi x10, x0, 16                                    ; pc=0x0200
    add x5, x3, x10                                     ; pc=0x0204
    add x7, x5, x5                                      ; pc=0x0208
    add x7, x7, x7                                      ; pc=0x020C
    addiSigned x9, x17, -1024                           ; pc=0x0210
    add x9, x9, x7                                      ; pc=0x0214
    lw x6, 0(x9)                                        ; pc=0x0218
    sw x6, -1064(x17) ; t13__x10                        ; pc=0x021C
    lw x10, -1064(x17) ; t13__x10                       ; pc=0x0220
    add x8, x4, x10                                     ; pc=0x0224
    add x4, x8, x0 ; promote suma                       ; pc=0x0228
    addi x7, x0, 24                                     ; pc=0x022C
    add x5, x3, x7                                      ; pc=0x0230
    add x9, x5, x5                                      ; pc=0x0234
    add x9, x9, x9                                      ; pc=0x0238
    addiSigned x6, x17, -1024                           ; pc=0x023C
    add x6, x6, x9                                      ; pc=0x0240
    lw x8, 0(x6)                                        ; pc=0x0244
    sw x8, -1072(x17) ; t15__x4                         ; pc=0x0248
    lw x10, -1072(x17) ; t15__x4                        ; pc=0x024C
    add x7, x4, x10                                     ; pc=0x0250
    add x4, x7, x0 ; promote suma                       ; pc=0x0254
    addi x9, x0, 32                                     ; pc=0x0258
    add x5, x3, x9                                      ; pc=0x025C
    add x3, x5, x0 ; promote i                          ; pc=0x0260
