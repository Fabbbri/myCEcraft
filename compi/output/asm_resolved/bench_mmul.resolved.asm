...
.L_ir_5_ir_cmp_end:
    ...
    beq x6, x0, 344                                     ; pc=0x0108 ; target=L_while_end_3 ; addr=0x0260
...
.L_ir_7_ir_cmp_end:
    ...
    beq x8, x0, 272                                     ; pc=0x0130 ; target=L_while_end_5 ; addr=0x0240
...
.L_ir_9_ir_cmp_end:
    ...
    beq x9, x0, 156                                     ; pc=0x016C ; target=L_while_end_7 ; addr=0x0208
...
L_while_start_8:
    ...
    blt x3, x9, 8                                       ; pc=0x0278 ; target=.L_ir_10_ir_cmp_true ; addr=0x0280
