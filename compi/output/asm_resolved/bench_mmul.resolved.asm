...
;   .L1_while_end = 0x00D8
;   .L2_while_start = 0x00E8
;   .L4_while_start = 0x00FC
;   .L6_while_start = 0x0120
;   .L7_while_end = 0x01A0
;   .L5_while_end = 0x01D8
;   .L3_while_end = 0x01FC
;   .L8_while_start = 0x020C
;   .L9_while_end = 0x0250
;   .L_codegen_1_main_end = 0x025C

; Referencias resueltas
;   pc=0x0000 portalv -> .L_codegen_0_enderExit (addr=0x0018, offset=24)
;   pc=0x0088 bge -> .L1_while_end (addr=0x00D8, offset=80)
;   pc=0x00D4 jal -> .L0_while_start (addr=0x0080, offset=-84)
;   pc=0x00F0 bge -> .L3_while_end (addr=0x01FC, offset=268)
;   pc=0x0104 bge -> .L5_while_end (addr=0x01D8, offset=212)
;   pc=0x0128 bge -> .L7_while_end (addr=0x01A0, offset=120)
;   pc=0x019C jal -> .L6_while_start (addr=0x0120, offset=-124)
;   pc=0x01D4 jal -> .L4_while_start (addr=0x00FC, offset=-216)
;   pc=0x01F8 jal -> .L2_while_start (addr=0x00E8, offset=-272)
;   pc=0x0214 bge -> .L9_while_end (addr=0x0250, offset=60)
;   pc=0x024C jal -> .L8_while_start (addr=0x020C, offset=-64)
;   pc=0x0258 jal -> .L_codegen_1_main_end (addr=0x025C, offset=4)
...
.L0_while_start:
    ...
    bge x3, x4, 80                                      ; pc=0x0088 ; target=.L1_while_end ; addr=0x00D8
    ...
    jal x0, -84                                         ; pc=0x00D4 ; target=.L0_while_start ; addr=0x0080
.L1_while_end:
...
.L2_while_start:
    ...
    bge x5, x3, 268                                     ; pc=0x00F0 ; target=.L3_while_end ; addr=0x01FC
...
.L4_while_start:
    ...
    bge x3, x5, 212                                     ; pc=0x0104 ; target=.L5_while_end ; addr=0x01D8
...
.L6_while_start:
    ...
    bge x5, x3, 120                                     ; pc=0x0128 ; target=.L7_while_end ; addr=0x01A0
    ...
    jal x0, -124                                        ; pc=0x019C ; target=.L6_while_start ; addr=0x0120
.L7_while_end:
    ...
    jal x0, -216                                        ; pc=0x01D4 ; target=.L4_while_start ; addr=0x00FC
.L5_while_end:
    ...
    jal x0, -272                                        ; pc=0x01F8 ; target=.L2_while_start ; addr=0x00E8
.L3_while_end:
...
.L8_while_start:
    ...
    bge x3, x5, 60                                      ; pc=0x0214 ; target=.L9_while_end ; addr=0x0250
    ...
    jal x0, -64                                         ; pc=0x024C ; target=.L8_while_start ; addr=0x020C
.L9_while_end:

    lw x5, -796(x17) ; suma                             ; pc=0x0250
    add x11, x5, x0                                     ; pc=0x0254
    jal x0, 4                                           ; pc=0x0258 ; target=.L_codegen_1_main_end ; addr=0x025C
