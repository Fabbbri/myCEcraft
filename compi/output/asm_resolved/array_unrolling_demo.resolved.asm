...
;   L_for_end_1 = 0x00F4
;   .L_ir_1_main_end = 0x011C

; Referencias resueltas
;   pc=0x0000 portalv -> .L_ir_0_enderExit (addr=0x0018, offset=24)
;   pc=0x0090 blt -> .L_ir_2_ir_cmp_true (addr=0x0098, offset=8)
;   pc=0x0094 jal -> .L_ir_3_ir_cmp_end (addr=0x009C, offset=8)
;   pc=0x00A0 beq -> L_for_end_1 (addr=0x00F4, offset=84)
;   pc=0x00F0 jal -> L_for_start_0 (addr=0x0088, offset=-104)
;   pc=0x0118 jal -> .L_ir_1_main_end (addr=0x011C, offset=4)
...
.L_ir_3_ir_cmp_end:
    ...
    beq x4, x0, 84                                      ; pc=0x00A0 ; target=L_for_end_1 ; addr=0x00F4
    ...
    jal x0, -104                                        ; pc=0x00F0 ; target=L_for_start_0 ; addr=0x0088
L_for_end_1:
    ...
    jal x0, 4                                           ; pc=0x0118 ; target=.L_ir_1_main_end ; addr=0x011C
.L_ir_1_main_end:
    ; epilogue
