...
;   pc=0x006C beq -> L_for_end_1 (addr=0x009C, offset=48)
;   pc=0x0098 jal -> L_for_start_0 (addr=0x0050, offset=-72)
...
.L_ir_3_ir_cmp_end:
    ...
    beq x9, x0, 48                                      ; pc=0x006C ; target=L_for_end_1 ; addr=0x009C
    ...
    jal x0, -72                                         ; pc=0x0098 ; target=L_for_start_0 ; addr=0x0050
L_for_end_1:
