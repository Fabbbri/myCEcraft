...
;   L_while_end_7 = 0x0210
;   L_while_end_5 = 0x0248
;   L_while_end_3 = 0x0268
;   L_while_start_8 = 0x0278
;   .L_ir_10_ir_cmp_true = 0x0288
;   .L_ir_11_ir_cmp_end = 0x028C
;   L_while_end_9 = 0x02D8
;   .L_ir_1_main_end = 0x02E4
...
;   pc=0x0108 beq -> L_while_end_3 (addr=0x0268, offset=352)
;   pc=0x011C blt -> .L_ir_6_ir_cmp_true (addr=0x0124, offset=8)
;   pc=0x0120 jal -> .L_ir_7_ir_cmp_end (addr=0x0128, offset=8)
;   pc=0x0130 beq -> L_while_end_5 (addr=0x0248, offset=280)
;   pc=0x0158 blt -> .L_ir_8_ir_cmp_true (addr=0x0160, offset=8)
;   pc=0x015C jal -> .L_ir_9_ir_cmp_end (addr=0x0164, offset=8)
;   pc=0x016C beq -> L_while_end_7 (addr=0x0210, offset=164)
;   pc=0x020C jal -> L_while_start_6 (addr=0x014C, offset=-192)
;   pc=0x0244 jal -> L_while_start_4 (addr=0x0114, offset=-304)
;   pc=0x0264 jal -> L_while_start_2 (addr=0x00EC, offset=-376)
;   pc=0x0280 blt -> .L_ir_10_ir_cmp_true (addr=0x0288, offset=8)
;   pc=0x0284 jal -> .L_ir_11_ir_cmp_end (addr=0x028C, offset=8)
;   pc=0x0294 beq -> L_while_end_9 (addr=0x02D8, offset=68)
;   pc=0x02D4 jal -> L_while_start_8 (addr=0x0278, offset=-92)
;   pc=0x02E0 jal -> .L_ir_1_main_end (addr=0x02E4, offset=4)
...
.L_ir_5_ir_cmp_end:
    ...
    beq x6, x0, 352                                     ; pc=0x0108 ; target=L_while_end_3 ; addr=0x0268
    addi x5, x0, 0                                      ; pc=0x010C
    add x4, x5, x0 ; promote j                          ; pc=0x0110
L_while_start_4:
    addi x7, x0, 8                                      ; pc=0x0114
    addi x10, x0, 0                                     ; pc=0x0118
    blt x4, x7, 8                                       ; pc=0x011C ; target=.L_ir_6_ir_cmp_true ; addr=0x0124
...
.L_ir_7_ir_cmp_end:
    ...
    beq x8, x0, 280                                     ; pc=0x0130 ; target=L_while_end_5 ; addr=0x0248
...
L_while_start_6:
    ...
    blt x10, x7, 8                                      ; pc=0x0158 ; target=.L_ir_8_ir_cmp_true ; addr=0x0160
...
.L_ir_9_ir_cmp_end:
    ...
    beq x9, x0, 164                                     ; pc=0x016C ; target=L_while_end_7 ; addr=0x0210
    ...
    lw x6, -780(x17) ; k                                ; pc=0x01C4
    addi x5, x0, 1                                      ; pc=0x01C8
    add x7, x6, x5                                      ; pc=0x01CC
    sw x7, -836(x17) ; t11                              ; pc=0x01D0
    lw x10, -824(x17) ; t6                              ; pc=0x01D4
    lw x9, -832(x17) ; t8                               ; pc=0x01D8
    mul x8, x10, x9                                     ; pc=0x01DC
    sw x8, -840(x17) ; t9                               ; pc=0x01E0
    lw x7, -792(x17) ; acc                              ; pc=0x01E4
    lw x5, -840(x17) ; t9                               ; pc=0x01E8
    add x6, x7, x5                                      ; pc=0x01EC
    sw x6, -792(x17) ; acc                              ; pc=0x01F0
    lw x8, -836(x17) ; t11                              ; pc=0x01F4
    sw x8, -780(x17) ; k                                ; pc=0x01F8
    lw x9, -788(x17) ; kb                               ; pc=0x01FC
    addi x10, x0, 8                                     ; pc=0x0200
    add x6, x9, x10                                     ; pc=0x0204
    sw x6, -788(x17) ; kb                               ; pc=0x0208
    jal x0, -192                                        ; pc=0x020C ; target=L_while_start_6 ; addr=0x014C
L_while_end_7:
    lw x5, -784(x17) ; ia                               ; pc=0x0210
    add x7, x5, x4                                      ; pc=0x0214
    sw x7, -852(x17) ; t13                              ; pc=0x0218
    lw x8, -792(x17) ; acc                              ; pc=0x021C
    lw x6, -852(x17) ; t13                              ; pc=0x0220
    add x10, x6, x6                                     ; pc=0x0224
    add x10, x10, x10                                   ; pc=0x0228
    addiSigned x9, x17, -768                            ; pc=0x022C
    add x9, x9, x10                                     ; pc=0x0230
    sw x8, 0(x9)                                        ; pc=0x0234
    addi x7, x0, 1                                      ; pc=0x0238
    add x5, x4, x7                                      ; pc=0x023C
    add x4, x5, x0 ; promote j                          ; pc=0x0240
    jal x0, -304                                        ; pc=0x0244 ; target=L_while_start_4 ; addr=0x0114
L_while_end_5:
    addi x10, x0, 1                                     ; pc=0x0248
    add x6, x3, x10                                     ; pc=0x024C
    add x3, x6, x0 ; promote i                          ; pc=0x0250
    lw x9, -784(x17) ; ia                               ; pc=0x0254
    addi x8, x0, 8                                      ; pc=0x0258
    add x5, x9, x8                                      ; pc=0x025C
    sw x5, -784(x17) ; ia                               ; pc=0x0260
    jal x0, -376                                        ; pc=0x0264 ; target=L_while_start_2 ; addr=0x00EC
L_while_end_3:
    addi x7, x0, 0                                      ; pc=0x0268
    sw x7, -796(x17) ; suma                             ; pc=0x026C
    addi x6, x0, 0                                      ; pc=0x0270
    add x3, x6, x0 ; promote i                          ; pc=0x0274
L_while_start_8:
    addi x10, x0, 64                                    ; pc=0x0278
    addi x5, x0, 0                                      ; pc=0x027C
    blt x3, x10, 8                                      ; pc=0x0280 ; target=.L_ir_10_ir_cmp_true ; addr=0x0288
    jal x0, 8                                           ; pc=0x0284 ; target=.L_ir_11_ir_cmp_end ; addr=0x028C
.L_ir_10_ir_cmp_true:
    addi x5, x0, 1                                      ; pc=0x0288
.L_ir_11_ir_cmp_end:
    sw x5, -868(x17) ; t17                              ; pc=0x028C
    lw x8, -868(x17) ; t17                              ; pc=0x0290
    beq x8, x0, 68                                      ; pc=0x0294 ; target=L_while_end_9 ; addr=0x02D8
    add x9, x3, x3                                      ; pc=0x0298
    add x9, x9, x9                                      ; pc=0x029C
    addiSigned x7, x17, -768                            ; pc=0x02A0
    add x7, x7, x9                                      ; pc=0x02A4
    lw x6, 0(x7)                                        ; pc=0x02A8
    sw x6, -872(x17) ; t18                              ; pc=0x02AC
    addi x5, x0, 1                                      ; pc=0x02B0
    add x10, x3, x5                                     ; pc=0x02B4
    sw x10, -876(x17) ; t20                             ; pc=0x02B8
    lw x8, -796(x17) ; suma                             ; pc=0x02BC
    lw x9, -872(x17) ; t18                              ; pc=0x02C0
    add x7, x8, x9                                      ; pc=0x02C4
    sw x7, -796(x17) ; suma                             ; pc=0x02C8
    lw x6, -876(x17) ; t20                              ; pc=0x02CC
    add x3, x6, x0 ; promote i                          ; pc=0x02D0
    jal x0, -92                                         ; pc=0x02D4 ; target=L_while_start_8 ; addr=0x0278
L_while_end_9:
    lw x10, -796(x17) ; suma                            ; pc=0x02D8
    add x11, x10, x0                                    ; pc=0x02DC
    jal x0, 4                                           ; pc=0x02E0 ; target=.L_ir_1_main_end ; addr=0x02E4
.L_ir_1_main_end:
    ; epilogue
    lw x17, 4(x2)                                       ; pc=0x02E4
    addi x2, x2, 888                                    ; pc=0x02E8
    freeze                                              ; pc=0x02EC