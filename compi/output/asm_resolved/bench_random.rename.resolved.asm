...
.L_ir_5_ir_cmp_end:
    ...
    beq x5, x0, 120                                     ; pc=0x00C0 ; target=L_while_end_3 ; addr=0x0138
    ...
    bge x4, x8, 8                                       ; pc=0x0100 ; target=.L_ir_6_ir_cmp_true ; addr=0x0108
...
.L_ir_7_ir_cmp_end:
    ...
    beq x9, x0, 20                                      ; pc=0x0114 ; target=L_else_4 ; addr=0x0128
