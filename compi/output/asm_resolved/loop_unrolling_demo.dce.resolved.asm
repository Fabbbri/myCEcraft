...
;   pc=0x0060 beq -> L_while_end_1 (addr=0x0084, offset=36)
;   pc=0x0080 jal -> L_while_start_0 (addr=0x0048, offset=-56)
...
.L_ir_3_ir_cmp_end:
    ...
    beq x6, x0, 36                                      ; pc=0x0060 ; target=L_while_end_1 ; addr=0x0084
    ...
    jal x0, -56                                         ; pc=0x0080 ; target=L_while_start_0 ; addr=0x0048
L_while_end_1:
