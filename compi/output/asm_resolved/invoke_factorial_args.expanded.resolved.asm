...
;   main = 0x0020
;   .L_codegen_1_main_end = 0x019C
;   factorial = 0x01C0
;   .L0_while_start = 0x0214
;   .L1_while_end = 0x02B4
;   .L_codegen_2_factorial_end = 0x02E0

; Referencias resueltas
;   pc=0x0000 portalv -> .L_codegen_0_enderExit (addr=0x0020, offset=32)
;   pc=0x00D0 jal -> factorial (addr=0x01C0, offset=240)
;   pc=0x0130 jal -> factorial (addr=0x01C0, offset=144)
;   pc=0x0190 jal -> .L_codegen_1_main_end (addr=0x019C, offset=12)
;   pc=0x0234 blt -> .L1_while_end (addr=0x02B4, offset=128)
;   pc=0x02A8 jal -> .L0_while_start (addr=0x0214, offset=-148)
;   pc=0x02D4 jal -> .L_codegen_2_factorial_end (addr=0x02E0, offset=12)
...
main:
    ...
    jal x1, 240                                         ; pc=0x00D0 ; target=factorial ; addr=0x01C0
    ...
    jal x1, 144                                         ; pc=0x0130 ; target=factorial ; addr=0x01C0
    ...
    jal x0, 12                                          ; pc=0x0190 ; target=.L_codegen_1_main_end ; addr=0x019C
...
.L0_while_start:
    ...
    blt x4, x5, 128                                     ; pc=0x0234 ; target=.L1_while_end ; addr=0x02B4
    ...
    jal x0, -148                                        ; pc=0x02A8 ; target=.L0_while_start ; addr=0x0214
...
.L1_while_end:
    ...
    jal x0, 12                                          ; pc=0x02D4 ; target=.L_codegen_2_factorial_end ; addr=0x02E0
