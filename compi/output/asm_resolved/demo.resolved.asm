...
;   .L1_while_end = 0x00E8
;   .L_codegen_1_main_end = 0x0114

; Referencias resueltas
;   pc=0x0000 portalv -> .L_codegen_0_enderExit (addr=0x0020, offset=32)
;   pc=0x009C bge -> .L1_while_end (addr=0x00E8, offset=76)
;   pc=0x00DC jal -> .L0_while_start (addr=0x007C, offset=-96)
;   pc=0x0108 jal -> .L_codegen_1_main_end (addr=0x0114, offset=12)
...
.L0_while_start:
    ...
    bge x3, x4, 76                                      ; pc=0x009C ; target=.L1_while_end ; addr=0x00E8
    ...
    jal x0, -96                                         ; pc=0x00DC ; target=.L0_while_start ; addr=0x007C
...
.L1_while_end:
    ...
    jal x0, 12                                          ; pc=0x0108 ; target=.L_codegen_1_main_end ; addr=0x0114
