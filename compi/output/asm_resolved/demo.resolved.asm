...
;   main = 0x001C
;   .L0_while_start = 0x0058
;   .L1_while_end = 0x00BC
;   .L_codegen_1_main_end = 0x00E4

; Referencias resueltas
;   pc=0x0000 portalv -> .L_codegen_0_enderExit (addr=0x001C, offset=28)
;   pc=0x0078 bge -> .L1_while_end (addr=0x00BC, offset=68)
;   pc=0x00B4 jal -> .L0_while_start (addr=0x0058, offset=-92)
;   pc=0x00DC jal -> .L_codegen_1_main_end (addr=0x00E4, offset=8)
...
.L0_while_start:
    ...
    bge x3, x4, 68                                      ; pc=0x0078 ; target=.L1_while_end ; addr=0x00BC
    ...
    jal x0, -92                                         ; pc=0x00B4 ; target=.L0_while_start ; addr=0x0058
...
.L1_while_end:
    ...
    jal x0, 8                                           ; pc=0x00DC ; target=.L_codegen_1_main_end ; addr=0x00E4
