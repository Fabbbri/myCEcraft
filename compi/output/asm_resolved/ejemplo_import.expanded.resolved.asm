...
;   main = 0x001C
;   .L_codegen_1_main_end = 0x00C8
;   suma = 0x0100
;   .L_codegen_2_suma_end = 0x0178

; Referencias resueltas
;   pc=0x0000 portalv -> .L_codegen_0_enderExit (addr=0x001C, offset=28)
;   pc=0x0084 jal -> suma (addr=0x0100, offset=124)
;   pc=0x00C0 jal -> .L_codegen_1_main_end (addr=0x00C8, offset=8)
;   pc=0x0170 jal -> .L_codegen_2_suma_end (addr=0x0178, offset=8)
...
main:
    ...
    jal x1, 124                                         ; pc=0x0084 ; target=suma ; addr=0x0100
    ...
    jal x0, 8                                           ; pc=0x00C0 ; target=.L_codegen_1_main_end ; addr=0x00C8
...
suma:
    ...
    jal x0, 8                                           ; pc=0x0170 ; target=.L_codegen_2_suma_end ; addr=0x0178
