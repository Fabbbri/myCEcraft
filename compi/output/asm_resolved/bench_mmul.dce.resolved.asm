...
;   L_while_end_7 = 0x01D8
;   L_while_end_5 = 0x0210
;   L_while_end_3 = 0x0230
;   L_while_start_8 = 0x0240
;   .L_ir_10_ir_cmp_true = 0x0250
;   .L_ir_11_ir_cmp_end = 0x0254
;   L_while_end_9 = 0x0298
;   .L_ir_1_main_end = 0x02A4
...
;   pc=0x00D8 beq -> L_while_end_3 (addr=0x0230, offset=344)
;   pc=0x00EC blt -> .L_ir_6_ir_cmp_true (addr=0x00F4, offset=8)
;   pc=0x00F0 jal -> .L_ir_7_ir_cmp_end (addr=0x00F8, offset=8)
;   pc=0x0100 beq -> L_while_end_5 (addr=0x0210, offset=272)
;   pc=0x0128 blt -> .L_ir_8_ir_cmp_true (addr=0x0130, offset=8)
;   pc=0x012C jal -> .L_ir_9_ir_cmp_end (addr=0x0134, offset=8)
;   pc=0x013C beq -> L_while_end_7 (addr=0x01D8, offset=156)
;   pc=0x01D4 jal -> L_while_start_6 (addr=0x011C, offset=-184)
;   pc=0x020C jal -> L_while_start_4 (addr=0x00E4, offset=-296)
;   pc=0x022C jal -> L_while_start_2 (addr=0x00BC, offset=-368)
;   pc=0x0248 blt -> .L_ir_10_ir_cmp_true (addr=0x0250, offset=8)
;   pc=0x024C jal -> .L_ir_11_ir_cmp_end (addr=0x0254, offset=8)
;   pc=0x025C beq -> L_while_end_9 (addr=0x0298, offset=60)
;   pc=0x0294 jal -> L_while_start_8 (addr=0x0240, offset=-84)
;   pc=0x02A0 jal -> .L_ir_1_main_end (addr=0x02A4, offset=4)
...
.L_ir_5_ir_cmp_end:
    ...
    beq x6, x0, 344                                     ; pc=0x00D8 ; target=L_while_end_3 ; addr=0x0230
...
.L_ir_7_ir_cmp_end:
    ...
    beq x8, x0, 272                                     ; pc=0x0100 ; target=L_while_end_5 ; addr=0x0210
...
.L_ir_9_ir_cmp_end:
    ...
    beq x9, x0, 156                                     ; pc=0x013C ; target=L_while_end_7 ; addr=0x01D8
    ...
    jal x0, -184                                        ; pc=0x01D4 ; target=L_while_start_6 ; addr=0x011C
L_while_end_7:
    ...
    jal x0, -296                                        ; pc=0x020C ; target=L_while_start_4 ; addr=0x00E4
L_while_end_5:
    ...
    jal x0, -368                                        ; pc=0x022C ; target=L_while_start_2 ; addr=0x00BC
L_while_end_3:
...
L_while_start_8:
    ...
    blt x3, x9, 8                                       ; pc=0x0248 ; target=.L_ir_10_ir_cmp_true ; addr=0x0250
    jal x0, 8                                           ; pc=0x024C ; target=.L_ir_11_ir_cmp_end ; addr=0x0254
.L_ir_10_ir_cmp_true:
    addi x6, x0, 1                                      ; pc=0x0250
.L_ir_11_ir_cmp_end:
    sw x6, -868(x17) ; t17                              ; pc=0x0254
    lw x7, -868(x17) ; t17                              ; pc=0x0258
    beq x7, x0, 60                                      ; pc=0x025C ; target=L_while_end_9 ; addr=0x0298
    ...
    jal x0, -84                                         ; pc=0x0294 ; target=L_while_start_8 ; addr=0x0240
L_while_end_9:
    lw x10, -796(x17) ; suma                            ; pc=0x0298
    add x11, x10, x0                                    ; pc=0x029C
    jal x0, 4                                           ; pc=0x02A0 ; target=.L_ir_1_main_end ; addr=0x02A4
.L_ir_1_main_end:
    ; epilogue
