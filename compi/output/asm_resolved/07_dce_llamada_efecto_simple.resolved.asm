...
;   marcar = 0x00F8
;   .L_ir_4_marcar_end = 0x013C

; Referencias resueltas
;   pc=0x0000 portalv -> .L_ir_0_enderExit (addr=0x0018, offset=24)
;   pc=0x0040 blt -> .L_ir_2_ir_cmp_true (addr=0x0048, offset=8)
;   pc=0x0044 jal -> .L_ir_3_ir_cmp_end (addr=0x004C, offset=8)
;   pc=0x0054 beq -> L_else_0 (addr=0x0084, offset=48)
;   pc=0x0080 jal -> L_end_if_1 (addr=0x00B4, offset=52)
;   pc=0x00CC jal -> marcar (addr=0x00F8, offset=44)
;   pc=0x00E8 jal -> .L_ir_1_main_end (addr=0x00EC, offset=4)
;   pc=0x0138 jal -> .L_ir_4_marcar_end (addr=0x013C, offset=4)
...
main:
    ...
    blt x8, x3, 8                                       ; pc=0x0040 ; target=.L_ir_2_ir_cmp_true ; addr=0x0048
...
.L_ir_3_ir_cmp_end:
    ...
    beq x10, x0, 48                                     ; pc=0x0054 ; target=L_else_0 ; addr=0x0084
    ...
    jal x0, 52                                          ; pc=0x0080 ; target=L_end_if_1 ; addr=0x00B4
L_else_0:
...
L_end_if_1:
    ...
    jal x1, 44                                          ; pc=0x00CC ; target=marcar ; addr=0x00F8
...
marcar:
    ...
    jal x0, 4                                           ; pc=0x0138 ; target=.L_ir_4_marcar_end ; addr=0x013C
.L_ir_4_marcar_end:
    ; epilogue
