...
;   .L4_if_else = 0x01D4
;   .L5_if_end = 0x01D4
;   .L_codegen_1_main_end = 0x01E0
;   tea_encrypt = 0x01EC
;   .L0_for_start = 0x024C
;   .L1_for_end = 0x0394
;   .L_codegen_2_tea_encrypt_end = 0x03CC
;   tea_decrypt = 0x03DC
;   .L2_for_start = 0x0444
;   .L3_for_end = 0x058C
;   .L_codegen_3_tea_decrypt_end = 0x05C4

; Referencias resueltas
;   pc=0x0000 portalv -> .L_codegen_0_enderExit (addr=0x0018, offset=24)
;   pc=0x00B8 jal -> tea_encrypt (addr=0x01EC, offset=308)
;   pc=0x0144 jal -> tea_decrypt (addr=0x03DC, offset=664)
;   pc=0x0180 bne -> .L4_if_else (addr=0x01D4, offset=84)
;   pc=0x01BC bne -> .L6_if_else (addr=0x01D0, offset=20)
;   pc=0x01C8 jal -> .L_codegen_1_main_end (addr=0x01E0, offset=24)
;   pc=0x01CC jal -> .L7_if_end (addr=0x01D0, offset=4)
;   pc=0x01D0 jal -> .L5_if_end (addr=0x01D4, offset=4)
;   pc=0x01DC jal -> .L_codegen_1_main_end (addr=0x01E0, offset=4)
;   pc=0x0254 bge -> .L1_for_end (addr=0x0394, offset=320)
;   pc=0x0390 jal -> .L0_for_start (addr=0x024C, offset=-324)
;   pc=0x044C bge -> .L3_for_end (addr=0x058C, offset=320)
;   pc=0x0588 jal -> .L2_for_start (addr=0x0444, offset=-324)
...
main:
    ...
    jal x1, 308                                         ; pc=0x00B8 ; target=tea_encrypt ; addr=0x01EC
    ...
    jal x1, 664                                         ; pc=0x0144 ; target=tea_decrypt ; addr=0x03DC
    ...
    bne x4, x3, 84                                      ; pc=0x0180 ; target=.L4_if_else ; addr=0x01D4
    ...
    bne x4, x3, 20                                      ; pc=0x01BC ; target=.L6_if_else ; addr=0x01D0
    addi x3, x0, 0                                      ; pc=0x01C0
    add x11, x3, x0                                     ; pc=0x01C4
    jal x0, 24                                          ; pc=0x01C8 ; target=.L_codegen_1_main_end ; addr=0x01E0
    jal x0, 4                                           ; pc=0x01CC ; target=.L7_if_end ; addr=0x01D0
.L6_if_else:
.L7_if_end:

    jal x0, 4                                           ; pc=0x01D0 ; target=.L5_if_end ; addr=0x01D4
.L4_if_else:
.L5_if_end:

    addi x3, x0, 1                                      ; pc=0x01D4
    add x11, x3, x0                                     ; pc=0x01D8
    jal x0, 4                                           ; pc=0x01DC ; target=.L_codegen_1_main_end ; addr=0x01E0
...
.L0_for_start:
    ...
    bge x5, x3, 320                                     ; pc=0x0254 ; target=.L1_for_end ; addr=0x0394
    ...
    jal x0, -324                                        ; pc=0x0390 ; target=.L0_for_start ; addr=0x024C
.L1_for_end:
...
.L2_for_start:
    ...
    bge x4, x6, 320                                     ; pc=0x044C ; target=.L3_for_end ; addr=0x058C
    ...
    jal x0, -324                                        ; pc=0x0588 ; target=.L2_for_start ; addr=0x0444
.L3_for_end:
