...
;   .L0_for_start = 0x07EC
;   .L1_for_end = 0x0C84
;   .L_codegen_2_tea_encrypt_end = 0x0D4C
;   tea_decrypt = 0x0D84
;   .L2_for_start = 0x0EC4
;   .L3_for_end = 0x135C
;   .L_codegen_3_tea_decrypt_end = 0x1424

; Referencias resueltas
;   pc=0x0000 portalv -> .L_codegen_0_enderExit (addr=0x001C, offset=28)
;   pc=0x024C jal -> tea_encrypt (addr=0x06CC, offset=1152)
;   pc=0x045C jal -> tea_decrypt (addr=0x0D84, offset=2344)
...
;   pc=0x080C bge -> .L1_for_end (addr=0x0C84, offset=1144)
;   pc=0x0C7C jal -> .L0_for_start (addr=0x07EC, offset=-1168)
;   pc=0x0EE4 bge -> .L3_for_end (addr=0x135C, offset=1144)
;   pc=0x1354 jal -> .L2_for_start (addr=0x0EC4, offset=-1168)
...
main:
    ...
    jal x1, 1152                                        ; pc=0x024C ; target=tea_encrypt ; addr=0x06CC
    ...
    jal x1, 2344                                        ; pc=0x045C ; target=tea_decrypt ; addr=0x0D84
