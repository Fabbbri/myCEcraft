...
;   main = 0x001C
;   .L0_while_start = 0x006C
;   .L4_if_else = 0x0154
;   .L5_if_end = 0x0188
;   .L2_if_else = 0x0190
;   .L3_if_end = 0x01C4
;   .L1_while_end = 0x0200
;   .L_codegen_1_main_end = 0x0228

; Referencias resueltas
;   pc=0x0000 portalv -> .L_codegen_0_enderExit (addr=0x001C, offset=28)
;   pc=0x008C bge -> .L1_while_end (addr=0x0200, offset=372)
;   pc=0x00B4 bge -> .L2_if_else (addr=0x0190, offset=220)
;   pc=0x0110 bne -> .L4_if_else (addr=0x0154, offset=68)
;   pc=0x014C jal -> .L5_if_end (addr=0x0188, offset=60)
;   pc=0x0188 jal -> .L3_if_end (addr=0x01C4, offset=60)
;   pc=0x01F8 jal -> .L0_while_start (addr=0x006C, offset=-396)
;   pc=0x0220 jal -> .L_codegen_1_main_end (addr=0x0228, offset=8)
...
.L0_while_start:
    ...
    bge x3, x4, 372                                     ; pc=0x008C ; target=.L1_while_end ; addr=0x0200
    ...
    bge x4, x3, 220                                     ; pc=0x00B4 ; target=.L2_if_else ; addr=0x0190
    ...
    bne x5, x4, 68                                      ; pc=0x0110 ; target=.L4_if_else ; addr=0x0154
    ...
    jal x0, 60                                          ; pc=0x014C ; target=.L5_if_end ; addr=0x0188
...
.L5_if_end:
    ...
    jal x0, 60                                          ; pc=0x0188 ; target=.L3_if_end ; addr=0x01C4
...
.L3_if_end:
    ...
    jal x0, -396                                        ; pc=0x01F8 ; target=.L0_while_start ; addr=0x006C
...
.L1_while_end:
    ...
    jal x0, 8                                           ; pc=0x0220 ; target=.L_codegen_1_main_end ; addr=0x0228
    sleep ; nop despues de control                      ; pc=0x0224
.L_codegen_1_main_end:
    ; epilogue
    lw x1, 0(x2)                                        ; pc=0x0228
    ...
    ; final de programa
    addiHIGH x1, x0, 0xDEAD                             ; pc=0x0260
