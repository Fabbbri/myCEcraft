...
;   factorial = 0x0058
;   L_while_start_0 = 0x0084
;   .L_ir_3_ir_cmp_true = 0x0090
;   .L_ir_4_ir_cmp_end = 0x0094
;   L_while_end_1 = 0x00B4
;   .L_ir_2_factorial_end = 0x00BC

; Referencias resueltas
;   pc=0x0000 portalv -> .L_ir_0_enderExit (addr=0x0018, offset=24)
;   pc=0x0038 jal -> factorial (addr=0x0058, offset=32)
;   pc=0x0048 jal -> .L_ir_1_main_end (addr=0x004C, offset=4)
;   pc=0x0088 bge -> .L_ir_3_ir_cmp_true (addr=0x0090, offset=8)
;   pc=0x008C jal -> .L_ir_4_ir_cmp_end (addr=0x0094, offset=8)
;   pc=0x0098 beq -> L_while_end_1 (addr=0x00B4, offset=28)
;   pc=0x00B0 jal -> L_while_start_0 (addr=0x0084, offset=-44)
;   pc=0x00B8 jal -> .L_ir_2_factorial_end (addr=0x00BC, offset=4)
...
main:
    ...
    jal x1, 32                                          ; pc=0x0038 ; target=factorial ; addr=0x0058
...
L_while_start_0:
    ...
    bge x5, x3, 8                                       ; pc=0x0088 ; target=.L_ir_3_ir_cmp_true ; addr=0x0090
    jal x0, 8                                           ; pc=0x008C ; target=.L_ir_4_ir_cmp_end ; addr=0x0094
.L_ir_3_ir_cmp_true:
    addi x9, x0, 1                                      ; pc=0x0090
.L_ir_4_ir_cmp_end:
    add x6, x9, x0 ; promote t0                         ; pc=0x0094
    beq x6, x0, 28                                      ; pc=0x0098 ; target=L_while_end_1 ; addr=0x00B4
    ...
    jal x0, -44                                         ; pc=0x00B0 ; target=L_while_start_0 ; addr=0x0084
L_while_end_1:
    add x11, x4, x0                                     ; pc=0x00B4
    jal x0, 4                                           ; pc=0x00B8 ; target=.L_ir_2_factorial_end ; addr=0x00BC
